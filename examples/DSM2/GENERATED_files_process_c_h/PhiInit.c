...
_PhiInit[0]=pow(sin(-theta2)*l2*cos(theta1)+(l1+cos(-theta2)*l2)*sin(theta1)-z-z0,2.0)-pow(r,2.0)+pow((l1+cos(-theta2)*l2)*cos(theta1)-sin(-theta2)*l2*sin(theta1)-y-y0,2.0);
_PhiInit[1]=-sin(alpha)*y+cos(alpha)*z;
_PhiInit[2]=-2.0*cos(alpha)*((l1+cos(-theta2)*l2)*cos(theta1)-sin(-theta2)*l2*sin(theta1)-y-y0)-2.0*sin(alpha)*(sin(-theta2)*l2*cos(theta1)+(l1+cos(-theta2)*l2)*sin(theta1)-z-z0);
_PhiInit[3]=-theta1_0+theta1;
_PhiInit[4]=psi-psi_0;
return _PhiInit;
}
