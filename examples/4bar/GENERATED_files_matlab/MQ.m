function MQ_ = MQ(q,dq,time,param,inputs)
...
MQ_ = [-I2yy-(atom240^2+atom279^2)*m3-I3yy-2*atom244-I1yy-2*atom295-m2*l1^2 , atom317 , atom318 , -Fx3*atom110+Fz2*atom68-atom56-m2*g*atom68-My3-(atom33*atom330-atom42*atom339-atom30*atom327-atom340*atom43)*atom240-(atom287+l3z)*atom398-atom10*atom240-atom69*Fx2-(atom290-l3x)*atom401+atom351+(atom78^2*atom25*atom26+dtheta1*m2*atom15*atom71-atom78^2*atom24*atom27+dtheta1*m2*atom70*atom14)*l1-(m1*cg1z*atom15+m1*atom14*cg1x)*g-atom11*(atom241-l2x)+atom274+atom107*Fz3-My2-atom40-atom353*atom279+atom107*atom57;
atom317 , -2*atom298-I2yy-I3yy-l2^2*m3 , atom320 , atom11*l2x-atom56-My3-Fx3*atom122-Fz3*atom124-l2*atom353-atom57*atom124+atom401*(l3x-atom292)-(atom291+l3z)*atom398+atom351+atom274-My2-atom40;
atom318 , atom320 , -I3yy , -atom56-My3+atom401*l3x+atom351-atom398*l3z];
