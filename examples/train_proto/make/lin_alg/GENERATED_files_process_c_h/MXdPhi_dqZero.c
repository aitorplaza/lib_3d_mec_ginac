/*----------MXdPhi_dqZero.c lib3D_MEC exported-----------*/
...
#define Tm inputs[ 0 ]
#define Tb inputs[ 1 ]
double * _MXdPhi_dqZero = NULL;
void Init_MXdPhi_dqZero ( ) 
 {
    _MXdPhi_dqZero = malloc ( MXdPhi_dqZero_n_rows * MXdPhi_dqZero_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < MXdPhi_dqZero_n_rows * MXdPhi_dqZero_n_cols ; i++ ) {_MXdPhi_dqZero[i]=0.0;}
  }
 }

void Done_MXdPhi_dqZero ( ) 
{
if (_MXdPhi_dqZero != NULL) 
free (_MXdPhi_dqZero ); 
_MXdPhi_dqZero = NULL; 
}


double * MXdPhi_dqZero ()
{
if ( _MXdPhi_dqZero == NULL )
 {
    _MXdPhi_dqZero = malloc ( MXdPhi_dqZero_n_rows * MXdPhi_dqZero_n_cols * sizeof(double) );
...
{
#include "MXdPhi_dqZero_maple_include.c"
}
return _MXdPhi_dqZero;
}
