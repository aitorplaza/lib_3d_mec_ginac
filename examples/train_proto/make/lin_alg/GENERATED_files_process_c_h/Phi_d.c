...
void Init_Phi_d ( ) 
 {
    _Phi_d = malloc ( Phi_d_n_rows * Phi_d_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < Phi_d_n_rows * Phi_d_n_cols ; i++ ) {_Phi_d[i]=0.0;}
  }
 }
