...
void Init_Q_dq ( ) 
 {
    _Q_dq = malloc ( Q_dq_n_rows * Q_dq_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < Q_dq_n_rows * Q_dq_n_cols ; i++ ) {_Q_dq[i]=0.0;}
  }
 }
