...
void Init_Qgamma ( ) 
 {
    _Qgamma = malloc ( Qgamma_n_rows * Qgamma_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < Qgamma_n_rows * Qgamma_n_cols ; i++ ) {_Qgamma[i]=0.0;}
  }
 }
...
{
#include "Qgamma_maple_include.c"
}
return _Qgamma;
}
