...
void Init_Phi_z ( ) 
 {
    _Phi_z = malloc ( Phi_z_n_rows * Phi_z_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < Phi_z_n_rows * Phi_z_n_cols ; i++ ) {_Phi_z[i]=0.0;}
  }
 }
