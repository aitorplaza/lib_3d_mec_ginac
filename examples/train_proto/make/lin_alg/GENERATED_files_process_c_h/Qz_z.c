...
void Init_Qz_z ( ) 
 {
    _Qz_z = malloc ( Qz_z_n_rows * Qz_z_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < Qz_z_n_rows * Qz_z_n_cols ; i++ ) {_Qz_z[i]=0.0;}
  }
 }
