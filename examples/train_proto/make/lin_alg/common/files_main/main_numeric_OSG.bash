...
COMMON="time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Phi.c Beta.c write_data_file.c"
...
g++ $Q -D$1 -o $MAIN $MAIN.cc time.o gen_coord.o gen_vel.o gen_accel.o param.o unknowns.o inputs.o Phi.o Beta.o write_data_file.o PhiInit.o PhiInit_q.o dPhiInit_dq.o BetaInit.o Phi_q.o dPhi_dq.o Qgamma.o MXdPhi_dqZero.o read_config_file.o newton_raphson_min_norm.o solids_homogeneous_matrix.o osg_read_file.o osg_root.o osg_state.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
