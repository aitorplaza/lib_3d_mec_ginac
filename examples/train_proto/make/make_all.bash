...
RELEASE=RELEASE_1
g++ -D$METHOD -DORDER=$ORDER -DMAPLE=$MAPLE -D$TYPE -D$SLIP -D$GRPH -D$RELEASE -o $NAME $NAME.cc `pkg-config --cflags --libs lib_3d_mec_ginac-1.1 ginac`
