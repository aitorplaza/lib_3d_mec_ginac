...
//	Torsor3D * F_spring_4 = sys.new_Torsor3D ( "F_spring_4", -F_spring, -M_Zero, M4 , S4 , "Constitutive") ;
	...
	//	External ===> Inputs
	Torsor3D * T_motor_5 = sys.new_Torsor3D ( "T_motor_5",  F_Zero,  T_motor, G5 , S5 , "External") ;
...
*/
	//	Joints ===> Unkkonwns
//	Torsor3D * F_E_53_3 = sys.new_Torsor3D ( "F_E_53_3",  F_E_53,  M_Zero, PG3 , S3 , "Constitutive") ;
//	Torsor3D * F_E_53_5 = sys.new_Torsor3D ( "F_E_53_5", -F_E_53, -M_Zero, PG5 , S5 , "Constitutive") ;

//	Torsor3D * F_T_53_3 = sys.new_Torsor3D ( "F_T_53_3",  F_T_53,  M_Zero, PG3 , S3 , "Constitutive") ;
//	Torsor3D * F_T_53_5 = sys.new_Torsor3D ( "F_T_53_5", -F_T_53, -M_Zero, PG5 , S5 , "Constitutive") ;
...
sys.Matrix_Calculation(Phi,Init,Init_t,Dynamic_Equations,sys,METHOD);
// ************************************************************************************************
// Export C code for Direct Simulation 
// ************************************************************************************************
cout << "Export C code for Direct Simulation" << endl;

sys.export_Dynamic_Simulation_COMMON(sys, ORDER , MAPLE);
sys.export_Dynamic_Simulation_MAIN(sys, ORDER , MAPLE);
sys.export_Dynamic_Simulation_Z_D(sys, ORDER , MAPLE);
// ************************************************************************************************
