...
// ------------------------------------------------------------------------------------------------
	...
	Vector3D VabsM2 	= sys.Dt(OO_M2,"xyz");
	Vector3D VabsM4		= sys.Dt(OO_M4,"xyz");
	Vector3D VabsMS4		= sys.Dt(OO_MS4,"xyz");
	Vector3D VabsMS6		= sys.Dt(OO_MS6,"xyz");

	Vector3D VabsPG3	= sys.Dt(OO_PG3,"xyz");
	Vector3D VabsPG5	= sys.Dt(OO_PG5,"xyz");

	Vector3D VabsP3 	= sys.Dt(OO_O3,"xyz") + (Omega3 ^ O3_PG3);
	Vector3D VabsP5 	= sys.Dt(OO_O5,"xyz") + (Omega5 ^ O5_PG5);
...
// ------------------------------------------------------------------------------------------------
	...
	Solid * S1 = sys.new_Solid("S1","O1","B1","m1","O1_G1","I1_O1");
	Solid * S2 = sys.new_Solid("S2","O2","B2","m2","O2_G2","I2_O2");
	Solid * S3 = sys.new_Solid("S3","O3","B3","m3","O3_G3","I3_O3");
	Solid * S4 = sys.new_Solid("S4","O4","B4","m4","O4_G4","I4_O4");
	Solid * S5 = sys.new_Solid("S5","O5","B5","m5","O5_G5","I5_O5");
	Solid * S6 = sys.new_Solid("S6","O6","B6","m6","O6_G6","I6_O6");
...
// ************************************************************************************************
	...
	Drawing3D * D_S1 = sys.new_Drawing3D("D_S1","S1","./solids/sol1.osg",1,0,0,0.8);
	Drawing3D * D_S2 = sys.new_Drawing3D("D_S2","S2","./solids/sol2.osg",0,1,0,0.5);
	Drawing3D * D_S3 = sys.new_Drawing3D("D_S3","S3","./solids/sol3.osg",0,0,1,1.0);
	Drawing3D * D_S4 = sys.new_Drawing3D("D_S4","S4","./solids/sol4.osg",1,1,0,0.2);
	Drawing3D * D_S5 = sys.new_Drawing3D("D_S5","S5","./solids/sol5.osg",1,0,1,1.0);
	Drawing3D * D_S6 = sys.new_Drawing3D("D_S6","S6","./solids/sol6.osg",0,1,1,0.2);

	Drawing3D * FraABS = sys.new_Drawing3D("FraABS",Frame_abs,0.1);
        Drawing3D * FraR1 = sys.new_Drawing3D("FraR1",R1,0.1);	
        Drawing3D * FraR2 = sys.new_Drawing3D("FraR2",R2,0.1);
        Drawing3D * FraR3 = sys.new_Drawing3D("FraR3",R3,0.1);
        Drawing3D * FraR4 = sys.new_Drawing3D("FraR4",R4,0.1);
        Drawing3D * FraR5 = sys.new_Drawing3D("FraR5",R5,0.1);
        Drawing3D * FraR6 = sys.new_Drawing3D("FraR6",R6,0.1);
...
//*************************************************************************************************
	...
	Vector3D F_E_53   = *sys.new_Vector3D("F_E_53",0,0,-Fn,"B2");	// Wrench.
	...
	Vector3D F_T_53 	= *sys.new_Vector3D("F_T_53",0,Ft,0,"B2");	// Wrench.
#endif
	...
	Vector3D F_E_53 = *sys.new_Vector3D("F_E_53",0,Ft,Fn,"B2");	// Wrench.
	// Tang. Force. Defined actuating on solid 3.
	Vector3D F_T_53 	= *sys.new_Vector3D("F_T_53",0,0,0,"B2");	// Wrench.
#endif
	...
	ex constr_eq_set_2 = -a3*Rr-a5*Rw;			// Condicion de no deliz.
...
//#define Wrench
	...
	Wrench3D * Gravity_S1 = sys.Gravity_Wrench("S1");
	Wrench3D * Gravity_S2 = sys.Gravity_Wrench("S2");
	Wrench3D * Gravity_S3 = sys.Gravity_Wrench("S3");
	Wrench3D * Gravity_S4 = sys.Gravity_Wrench("S4");
	Wrench3D * Gravity_S5 = sys.Gravity_Wrench("S5");
	Wrench3D * Gravity_S6 = sys.Gravity_Wrench("S6");

	//	Inertia
	Wrench3D * Inertia_S1 = sys.Inertia_Wrench("S1");
	Wrench3D * Inertia_S2 = sys.Inertia_Wrench("S2");
	Wrench3D * Inertia_S3 = sys.Inertia_Wrench("S3");
	Wrench3D * Inertia_S4 = sys.Inertia_Wrench("S4");
	Wrench3D * Inertia_S5 = sys.Inertia_Wrench("S5");
	Wrench3D * Inertia_S6 = sys.Inertia_Wrench("S6");



	//	Constitutive ===> State
	Wrench3D * F_spring_2 = sys.new_Wrench3D ( "F_spring_2",  F_spring,  M_Zero, M2 , S2 , "Constitutive") ;
	Wrench3D * F_spring_4 = sys.new_Wrench3D ( "F_spring_4", -F_spring, -M_Zero, M4 , S4 , "Constitutive") ;
	Wrench3D * F_susp_6 = sys.new_Wrench3D ( "F_susp_6",  F_susp,  M_Zero, MS6 , S6 , "Constitutive") ;
	Wrench3D * F_susp_4 = sys.new_Wrench3D ( "F_susp_4", -F_susp, -M_Zero, MS4 , S4 , "Constitutive") ;

	//	External ===> Inputs
	Wrench3D * T_motor_5 = sys.new_Wrench3D ( "T_motor_5",  F_Zero,  T_motor, G5 , S5 , "External") ;
	Wrench3D * T_motor_4 = sys.new_Wrench3D ( "T_motor_4", -F_Zero, -T_motor, G4 , S4 , "External") ;

	Wrench3D * T_brake_3 = sys.new_Wrench3D ( "T_brake_3",  F_Zero,  T_brake, G3 , S3 , "External") ;
	Wrench3D * T_brake_2 = sys.new_Wrench3D ( "T_brake_2", -F_Zero, -T_brake, G2 , S2 , "External") ;

	//	Joints ===> Unkonwns
	Wrench3D * F_E_53_3 = sys.new_Wrench3D ( "F_E_53_3",  F_E_53,  M_Zero, PG3 , S3 , "Joint") ;
	Wrench3D * F_E_53_5 = sys.new_Wrench3D ( "F_E_53_5", -F_E_53, -M_Zero, PG5 , S5 , "Joint") ;

	Wrench3D * F_T_53_3 = sys.new_Wrench3D ( "F_T_53_3",  F_T_53,  M_Zero, PG3 , S3 , "Joint") ;
	Wrench3D * F_T_53_5 = sys.new_Wrench3D ( "F_T_53_5", -F_T_53, -M_Zero, PG5 , S5 , "Joint") ;
