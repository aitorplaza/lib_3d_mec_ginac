...
_PhiInit[0] = -R+atom2692+L*sin(b1)+x+atom2691;
_PhiInit[1] = -e+atom2695+atom2694-atom79*sin(a1)*L+y;
_PhiInit[2] =  atom2697+atom79*L*cos(a1)+z-s1+atom2698;
_PhiInit[3] = -R-atom2692+L*sin(b2)+x+atom2691;
_PhiInit[4] =  e-atom2695+atom2694-atom103*L*sin(a2)+y;
_PhiInit[5] =  atom103*L*cos(a2)+atom2697-s2+z-atom2698;
_PhiInit[6] =  atom131*atom2743+atom2727+atom2742/2.0+x+atom2728;
_PhiInit[7] =  atom2730-atom131*atom2742+atom2743/2.0+y+atom2731;
_PhiInit[8] = -s3+atom2734+atom127*L*cos(a3)+z+atom2733;
_PhiInit[9] =  atom2770*atom131+atom2755+atom2769/2.0+atom2754+x;
_PhiInit[10] =  atom2770/2.0+atom2757+atom2758+y-atom131*atom2769;
_PhiInit[11] =  atom2761-s4+atom2760+z+atom168*L*cos(a4);
_PhiInit[12] = -atom2755+atom2790/2.0-atom131*atom2791+atom2754+x;
_PhiInit[13] =  atom2757+atom2790*atom131-atom2758+atom2791/2.0+y;
_PhiInit[14] = -atom2761-s5+atom2760+z+atom208*L*cos(a5);
_PhiInit[15] = -atom2812*atom131+atom2727+atom2811/2.0+x-atom2728;
_PhiInit[16] =  atom2812/2.0+atom2730+y-atom2731+atom131*atom2811;
_PhiInit[17] = -s6-atom2734+L*atom248*cos(a6)+z+atom2733;
