...
// ------------------------------------------------------------------------------------------------
	...
	Drawing3D * Estructura   = sys.new_Drawing3D("Estructura"  ,"O","xyz","./solids/Estructura.osg",0.47,0.62,0.8,1.0);
	Drawing3D * Cabeza       = sys.new_Drawing3D("Cabeza"      ,"Op","Base3","./solids/Cabeza.osg",0.23,0.27,0.29,1.0);
	Drawing3D * Carro11      = sys.new_Drawing3D("Carro11"     ,"B11","xyz","./solids/Carro.osg",0.5,0.5,0.5,1.0);
	Drawing3D * Carro12      = sys.new_Drawing3D("Carro12"     ,"B12","xyz","./solids/Carro.osg",0.5,0.5,0.5,1.0);
	Drawing3D * Carro21      = sys.new_Drawing3D("Carro21"     ,"B21","x'y'z'","./solids/Carro.osg",0.5,0.5,0.5,1.0);
	Drawing3D * Carro22      = sys.new_Drawing3D("Carro22"     ,"B22","x'y'z'","./solids/Carro.osg",0.5,0.5,0.5,1.0);
	Drawing3D * Carro31      = sys.new_Drawing3D("Carro31"     ,"B31","x''y''z''","./solids/Carro.osg",0.5,0.5,0.5,1.0);
	Drawing3D * Carro32      = sys.new_Drawing3D("Carro32"     ,"B32","x''y''z''","./solids/Carro.osg",0.5,0.5,0.5,1.0);
...
Drawing3D * Barra11      = sys.new_Drawing3D("Barra11"     ,"A11","Bb11","./solids/Barra.osg",0.33,0.41,0.47,1.0);
Drawing3D * Barra12      = sys.new_Drawing3D("Barra12"     ,"A12","Bb12","./solids/Barra.osg",0.33,0.41,0.47,1.0);
Drawing3D * Barra21      = sys.new_Drawing3D("Barra21"     ,"A21","Bb21","./solids/Barra.osg",0.33,0.41,0.47,1.0);
Drawing3D * Barra22      = sys.new_Drawing3D("Barra22"     ,"A22","Bb22","./solids/Barra.osg",0.33,0.41,0.47,1.0);
Drawing3D * Barra31      = sys.new_Drawing3D("Barra31"     ,"A31","Bb31","./solids/Barra.osg",0.33,0.41,0.47,1.0);
Drawing3D * Barra32      = sys.new_Drawing3D("Barra32"     ,"A32","Bb32","./solids/Barra.osg",0.33,0.41,0.47,1.0);
