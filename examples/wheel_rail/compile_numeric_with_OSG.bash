...
COMMON="Declare_Variables.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Phi.c Beta.c Gamma.c Output.c write_data_file.c step.c"
COMMON_o=" Declare_Variables.o time.o gen_coord.o gen_vel.o gen_accel.o param.o unknowns.o inputs.o Phi.o Beta.o Gamma.o Output.o write_data_file.o step.o"
...
#added -DTRI_LDL to use LDL descomposition in dynamics
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DEULER -DCOORD_DEP $INIT -DDDL  -DTRI_LDL $TOL -DLIN_ALG -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDL $TRAIN one_step_euler.c
      g++ -c $OSG
      gcc  -DEULER -DCOORD_DEP $INIT -DDDL  -DTRI_LDL $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o $TRAIN_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      g++ -c $OSG
      gcc  -DEULER -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o $OSG_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 3 ];  then 
      ...
      g++ -c $OSG
      gcc -DEULER -DCOORD_IND $INIT $TOL -DLIN_ALG  -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o $OSG_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LDL $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDL  $TRAIN one_step_trapezoidal.c
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LDL $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o  $TRAIN_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o  $OSG_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 3 ];  then 
      ...
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_IND $INIT $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o  $OSG_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops                      
    fi
...
#added -DTRI_LU to use LU descomposition in dynamics
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DEULER -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDL $TRAIN one_step_euler.c
      g++ -c $OSG
      gcc  -DEULER -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o $TRAIN_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDL $TRAIN one_step_trapezoidal.c
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o $TRAIN_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
...
if [ "$MATH" == 3 ];  then
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      g++ -c $OSG
      gcc  -DEULER -DCOORD_DEP $INIT -DDDL -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      g++ -c $OSG
      gcc  -DEULER -DCOORD_DEP $INIT -DDDQ -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o $OSG_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o  $OSG_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
