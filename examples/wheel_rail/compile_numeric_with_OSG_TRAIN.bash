...
#added -DTRI_LDL to use LDL descomposition in dynamics
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DEULER -DCOORD_IND $INIT $TOL -DLIN_ALG -O2 -c  $COMMON $COORD_Z $L_A $TRAIN one_step_euler.c
      g++ -c $OSG
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LDL $TOL -O2 -c  $COMMON $COORD_Q $L_A $DYN_DDL  $TRAIN one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LDL $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o  $TRAIN_o  one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -O2 -c  $COMMON $COORD_Q $L_A $DYN_DDQ one_step_trapezoidal.c
      g++ -c $OSG
    ...
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_IND $INIT $TOL -O2 -c  $COMMON $COORD_Z $L_A $TRAIN one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_IND $INIT $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o $TRAIN_o $OSG_o  one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops                      
    fi
...
#added -DTRI_LU to use LU descomposition in dynamics
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -O2 -c  $COMMON $COORD_Q $L_A $DYN_DDL $TRAIN one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o $TRAIN_o  one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -c  $COMMON $COORD_Q $L_A $DYN_DDQ one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o  $OSG_o  one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_IND $INIT $TOL -O2 -c  $COMMON $COORD_Z $L_A $TRAIN  one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_IND $INIT $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o  $OSG_o $TRAIN_o   one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops                      
    fi
...
if [ "$MATH" == 3 ];  then
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DINV $TOL -O2 -c  $COMMON $COORD_Q $L_A $DYN_DDL $TRAIN one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o $TRAIN_o  one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DINV $TOL -O2 -c  $COMMON $COORD_Q $L_A $DYN_DDQ one_step_trapezoidal.c
      g++ -c $OSG
