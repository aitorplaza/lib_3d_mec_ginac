...
atom465 = -uR_R+atom320-fsR+y+(0.5)*atom409*L_R+uW_R*atom146+atom6*atom316+atom318*atom147-atom390*atom382;
atom144 = -atom6*atom3;
...
atom650 = -atom320-(0.5)*atom594*L_R-uR_L+y-fsL+uW_L*atom146+atom506*atom147+atom6*atom504-atom567*atom575;
atom557 = uR_L-lR_L;
...
Phit_ = [-atom457*atom438*(sR_R-atom5*atom316-atom318*atom145-uW_R*atom144-x-atom319+(0.5)*atom405*atom409*L_R)+atom457*atom465*atom440;
atom462*atom465-atom462*atom443*(atom372*atom376-z+usRz-uW_R*atom4+dR_R-atom321-atom318*atom3);
...
atom625*atom642*atom650+(atom5*atom504+atom506*atom145+(0.5)*atom590*atom594*L_R-sR_L+x+atom144*uW_L-atom319)*atom642*atom623;
atom647*atom650-(dR_L-z+usLz+atom557*atom561-uW_L*atom4+atom321-atom506*atom3)*atom647*atom628;
