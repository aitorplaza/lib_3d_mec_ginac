...
// ************************************************************************************************
	...
	Drawing3D * D_WHS   = sys.new_Drawing3D("D_WHS","WHS","./solids/axe.stl",1,0,0,1.0);

	Drawing3D * D_WHS_R = sys.new_Drawing3D("D_WHS_R","P_WHSR","B_WHS","./solids/disc.stl",1,0,0,0.8);
	Drawing3D * D_WHS_L = sys.new_Drawing3D("D_WHS_L","P_WHSL","B_WHS","./solids/disc.stl",1,0,0,0.8);

	Drawing3D * D_RailR = sys.new_Drawing3D("D_RailR","P_RailR","B_Rail","./solids/rail.stl",1,0,1,1.0);
	Drawing3D * D_RailL = sys.new_Drawing3D("D_RailL","P_RailL","B_Rail","./solids/rail.stl",1,0,1,1.0);
