...
if [ -z $3 ] ; then 
  ...
  echo "----------------------------------------------"
  echo "Enter 0 0 0 if you just want the OpenSceneGraph model for animation"
  echo "----------------------------------------------"
...
COMMON="Declare_Variables.c time_3D_mec.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Phi.c Beta.c Gamma.c write_data_file.c step.c read_config_file.c"
COMMON_o=" Declare_Variables.o time_3D_mec.o gen_coord.o gen_vel.o gen_accel.o param.o unknowns.o inputs.o Phi.o Beta.o Gamma.o write_data_file.o step.o read_config_file.o"
...
COORD_Z="PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c M.c Q.c MQ.c"
COORD_Z_o="PhiInit.o PhiInit_q.o dPhiInit_dq.o BetaInit.o Phi_q.o dPhi_dq.o M.o Q.o MQ.o"
...
if [ "$MATH" == 0 ] && [ "$INTEG" == 0 ] && [ "$FORM" == 0 ]; then
   echo "Compiling OpenSceneGraph model for animation";
   gcc  -O2 -c read_config_file.c read_data_file.c $COMMON 
   g++ -c $OSG
   g++  -DANIMATION -O2 -o $MAIN $MAIN.cc $COMMON_o $OSG_o read_data_file.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
fi
...
#added -DTRI_LDL to use LDL descomposition in dynamics
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DEULER -DCOORD_DEP $INIT -DDDL  -DTRI_LDL $TOL -DLIN_ALG -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDL one_step_euler.c
      g++ -c $OSG
      g++  -DEULER -DCOORD_DEP $INIT -DDDL  -DTRI_LDL $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi

    if [ "$FORM" == 2 ];  then 
      echo "Compiling OpenSceneGraph model with Udwadia Formalism and EULER integrator, solving with LIN_ALG library and LDL";
      gcc -DEULER -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDQ one_step_euler.c
      g++ -c $OSG
    ...
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DEULER -DCOORD_IND $INIT $TOL -DLIN_ALG -O2 -c read_config_file.c $COMMON $COORD_Z $L_A one_step_euler.c
      g++ -c $OSG
      g++ -DEULER -DCOORD_IND $INIT $TOL -DLIN_ALG  -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o $OSG_o one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LDL $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDL one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LDL $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDQ one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o  $OSG_oone_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_IND $INIT $TOL -O2 -c read_config_file.c $COMMON $COORD_Z $L_A  one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_IND $INIT $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o  $OSG_o one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops                      
    fi
...
#added -DTRI_LU to use LU descomposition in dynamics
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DEULER -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDL one_step_euler.c
      g++ -c $OSG
      g++  -DEULER -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi

    if [ "$FORM" == 2 ];  then 
      echo "Compiling OpenSceneGraph model with Udwadia Formalism and EULER integrator, solving with LIN_ALG library and LU";
      gcc -DEULER -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDQ one_step_euler.c
      g++ -c $OSG
      g++  -DEULER -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o $OSG_o one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 3 ];  then 
      echo "Compiling OpenSceneGraph model with Independent velocity Formalism and EULER integrator, solving with LIN_ALG library and LU";
      gcc -DEULER -DCOORD_IND $INIT $TOL -O2 -c read_config_file.c $COMMON $COORD_Z $L_A one_step_euler.c
      g++ -c $OSG
      g++ -DEULER -DCOORD_IND $INIT $TOL -DLIN_ALG  -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o $OSG_o one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDL one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDQ one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DTRI $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o  $OSG_o one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
...
if [ "$MATH" == 3 ];  then
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DEULER -DCOORD_DEP $INIT -DDDL -DINV $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDL one_step_euler.c
      g++ -c $OSG
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DEULER -DCOORD_DEP $INIT -DDDQ -DINV $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A  $DYN_DDQ one_step_euler.c
      g++ -c $OSG
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DINV $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDL one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DINV $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $DYN_DDQ one_step_trapezoidal.c
      g++ -c $OSG
      g++ -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDQ -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDQ_o $L_A_o  $OSG_o one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
...
if [ "$MATH" == 4 ];  then
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then
      ...
      g++ -c $OSG
      g++ -DCOORD_DEP -DDDL -DEULER -DLAPACK -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $OSG_o $DYN_DDL_o newton_raphson_min_norm.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then
      ...
      gcc -DCOORD_DEP -DDDL -O2 -c read_config_file.c newton_raphson_min_norm.c $COMMON $COORD_Q $DYN_DDL
      g++ -c $OSG
      g++ -DCOORD_DEP -DDDL -DTRAPEZOIDAL -DLAPACK -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $OSG_o $DYN_DDL_o newton_raphson_min_norm.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
    fi
