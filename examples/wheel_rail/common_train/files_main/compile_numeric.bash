...
#####################################################################################################################################################
  ...
  if [ "$INTEG" == 1 ];  then
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDL $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDL one_step_euler_q.c -lm
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDQ $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDQ one_step_euler_q.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Z $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Z one_step_euler_z.c -lm
      ./$MAIN $TTIME $TSTEP $name;		
    fi
  fi
  ...
  if [ "$INTEG" == 2 ];  then
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDL $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDL one_step_trapezoidal_q.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDQ $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDQ one_step_trapezoidal_q.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Z $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Z one_step_trapezoidal_z.c -lm
      ./$MAIN $TTIME $TSTEP $name;		
    fi
  fi
...
#####################################################################################################################################################
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDL $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDL one_step_euler_q.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDQ $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDQ one_step_euler_q.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDL $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDL one_step_trapezoidal_q.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDQ $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDQ one_step_trapezoidal_q.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
...
###################################################################################################
  ...
  if [ "$FORM" == 1 ] && [ "$INTEG" == 1 ];  then 
    ...
    gcc -DLIN_ALG -DTIME_OFF $EULER $Q $DDL $INV $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDL one_step_euler_q.c -lm
    ./$MAIN $TTIME $TSTEP $name;
  fi
  if [ "$FORM" == 1 ] && [ "$INTEG" == 2 ];  then 
    ...
    gcc -DLIN_ALG -DTIME_OFF $TRAPEZOIDAL $Q $DDL $INV $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $L_A $COORD_Q $DYN_DDL one_step_trapezoidal_q.c -lm
    ./$MAIN $TTIME $TSTEP $name;
  fi
