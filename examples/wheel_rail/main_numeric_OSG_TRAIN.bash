...
gcc -DEULER -DCOORD_DEP -DDDL -DINV $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $LA_Q $DYN_DDL $TRAIN one_step_euler_q.c
g++ -c $OSG
gcc  -DEULER -DCOORD_DEP -DDDL -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $LA_Q_o $OSG_o $TRAIN_o read_config_file.c one_step_euler_q.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
fi
if [ "$OPTION" == 4 ];  then 
...
gcc -DTRAPEZOIDAL -DCOORD_DEP -DDDL -DINV $TOL -O2 -funroll-loops -c read_config_file.c $COMMON $COORD_Q $L_A $LA_Q $DYN_DDL $TRAIN one_step_trapezoidal_q_train.c
g++ -c $OSG
gcc  -DTRAPEZOIDAL -DCOORD_DEP -DDDL -DINV $TOL -DLIN_ALG -O2 -funroll-loops -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $LA_Q_o $OSG_o $TRAIN_o read_config_file.c one_step_trapezoidal_q_train.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
fi
if [ "$OPTION" == 8 ];  then 
