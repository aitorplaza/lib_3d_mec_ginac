...
// ************************************************************************************************
    ...
    symbol_numeric z = *sys.new_Coordinate("z","dz","ddz",0.65 ,0.0,0.0);
...
// ************************************************************************************************
    ...
    symbol_numeric a_rail = *sys.new_Parameter("a_rail",0.00);
...
// ************************************************************************************************
    ...
    symbol_numeric tor = *sys.new_Parameter("tor",00.0);
