...
cout << "*    v 6.0 with splines and Kalker             *" << endl;
...
for (int i=0; (i < dPhit.rows()); ++i) {
    Betat(i,0) = recursive_substitution (Betat(i,0),Velocities , 0);
    Betat(i,0) = recursive_substitution (Betat(i,0),Aux_Velocities , 0);
}	
...
lst new_atom_list_Betat, new_exp_list_Betat;
matrix_list_optimize (Betat, new_atom_list_Betat,new_exp_list_Betat);
sys.export_Matrix_C	("Betat","_Betat",Betat, new_atom_list_Betat, new_exp_list_Betat ,ORDER);
sys.export_function_MATLAB("Betat", "Betat_",Betat, new_atom_list_Betat, new_exp_list_Betat,"q,qaux,time,param"); 
