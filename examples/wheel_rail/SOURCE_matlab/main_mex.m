...
if (choice == 3)
  ...
  fprintf(fid,'#define TRI_LDL\n');
  fclose(fid);
  set_param(MODELNAME, 'CustomSource', 'c_s_func_discrete.c lin_alg.c Declare_Variables.ctime.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c one_step_euler.c')
  end
 end
...
if (choice == 7)
 ...
 if (isunix)
  mex -v -DLIN_ALG -DCOORD_IND -DTRAPEZOIDAL c_s_func_discrete.c lin_alg.c Declare_Variables.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c  M.c Q.c  PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c one_step_trapezoidal.c -lm
 end  
 if (ispc)
...
if (choice == 10)
 ...
 if (isunix)
  mex -v -DLIN_ALG -DCOORD_DEP -DDDL -DTRI_LDL c_s_func_continuous.c lin_alg.c Declare_Variables.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Qgamma.c MXdPhi_dqZero.c Declare_Variables.c -lm
 end  
 if (ispc)
  mex -v -DLIN_ALG -DCOORD_DEP -DDDL -DTRI_LDL c_s_func_continuous.c lin_alg.c Declare_Variables.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Qgamma.c MXdPhi_dqZero.c 
 end
...
if (choice == 12)
 ...
 if (isunix)
  mex -v -DLIN_ALG -DCOORD_IND  c_s_func_continuous.c lin_alg.c Declare_Variables.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c -lm
 end  
 if (ispc)
  mex -v -DLIN_ALG -DCOORD_IND  c_s_func_continuous.c lin_alg.c Declare_Variables.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c
 end
end
