...
MODEL              = wheelset_continuous
MODULES            = rtGetInf.c rtGetNaN.c rt_nonfinite.c wheelset_continuous_acc_data.c 
MAKEFILE           = wheelset_continuous.mk
MATLAB_ROOT        = /usr/local/MATLAB/R2011b
ALT_MATLAB_ROOT    = /usr/local/MATLAB/R2011b
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/aitor/3d_mec/lib_3d_mec_ginac/examples/wheel_rail/SOURCE_matlab
S_FUNCTIONS        = c_s_func_continuous_train.c
S_FUNCTIONS_LIB    = 
SOLVER             = ode45.c
NUMST              = 3
TID01EQ            = 0
...
MODELLIB                  = wheelset_continuouslib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/wheelset_continuous \
	-I$(START_DIR) \
