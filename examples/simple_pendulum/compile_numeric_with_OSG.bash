...
#added -DTRI_LDL to use LDL descomposition in dynamics
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      g++ -c $OSG
      gcc  -DEULER -DCOORD_DEP $INIT -DDDL  -DTRI_LDL $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LDL $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
...
#added -DTRI_LU to use LU descomposition in dynamics
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      g++ -c $OSG
      gcc  -DEULER -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $OSG_o read_config_file.c one_step_euler.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      g++ -c $OSG
      gcc -DTRAPEZOIDAL -DCOORD_DEP $INIT -DDDL -DTRI_LU $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o  $OSG_o read_config_file.c one_step_trapezoidal.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack -ansi -funroll-loops
    fi
