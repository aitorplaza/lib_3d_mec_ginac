...
/* *********************** */
	...
	#ifdef INV
  	double Buffer[ 2 * n_gen_coord * n_gen_coord ];
	#endif

	#ifdef TRI
  	double BufferSLUs[ n_gen_coord ];
  	double BufferSLULU[ n_gen_coord * n_gen_coord ];
  	double BufferSLUy[ n_gen_coord ];
  	int BufferSLUo[ n_gen_coord ];
	#endif
...
/* *********************** */
	...
	#ifdef INV
		Mat_Inv( n_gen_coord, fq_q, INV_fq_q, Buffer);
		Mat_Vect_Mult(n_gen_coord, n_gen_coord, INV_fq_q, fq, -1.0, delta_q);
	#endif

	#ifdef TRI
		solve_lin_sys_lu(n_gen_coord, fq_q, fq, delta_q , BufferSLUs , BufferSLULU , BufferSLUy , BufferSLUo, niter);
...
#ifdef TRI
	solve_lin_sys_lu(n_gen_vel, fq_q, project_dq, dq,BufferSLUs, BufferSLULU, BufferSLUy, BufferSLUo, niter);
	solve_lin_sys_lu(n_gen_accel, fq_q, project_ddq, ddq,BufferSLUs, BufferSLULU, BufferSLUy, BufferSLUo, niter);
#endif
