...
double	correction_dq[dPhi_dq_n_cols];/*new*/
double _Inv_PhiInit_q[PhiInit_q_n_rows * PhiInit_q_n_cols];/*new*/
double _Inv_dPhiInit_dq[dPhiInit_dq_n_rows * dPhiInit_dq_n_cols];/*new*/
double _Inv_Phi_q[Phi_q_n_rows * Phi_q_n_cols];/*new*/
double _Inv_dPhi_dq[dPhi_dq_n_rows * dPhi_dq_n_cols];/*new*/
...
double LU[ Phi_d_n_cols * Phi_d_n_cols ], Y[ Phi_d_n_cols * Phi_z_n_cols ], y[Phi_d_n_cols];
int i, o[Phi_d_n_rows],p_vector[Phi_d_n_rows], q_vector[Phi_d_n_cols];
