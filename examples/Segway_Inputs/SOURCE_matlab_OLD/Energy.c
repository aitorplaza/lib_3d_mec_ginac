...
void Init_Energy ( ) 
 {
    _Energy = malloc ( Energy_n_rows * Energy_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < Energy_n_rows * Energy_n_cols ; i++ ) {_Energy[i]=0.0;}
  }
 }
...
{
#include "Energy_maple_include.c"
}
return _Energy;
}
