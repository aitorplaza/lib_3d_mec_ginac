...
{
fprintf ( data_file , "%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	%g	\n" , t , rho1 , phi1 , phi2 , phi3 , theta1 , xp , yp , zp , drho1 , dphi1 , dphi2 , dphi3 , dtheta1 , dxp , dyp , dzp , ddrho1 , ddphi1 , ddphi2 , ddphi3 , ddtheta1 , ddxp , ddyp , ddzp );
}

void write_data_file_header ( FILE * data_file )
{
fprintf ( data_file , "t	rho1	phi1	phi2	phi3	theta1	xp	yp	zp	drho1	dphi1	dphi2	dphi3	dtheta1	dxp	dyp	dzp	ddrho1	ddphi1	ddphi2	ddphi3	ddtheta1	ddxp	ddyp	ddzp	\n" );
}
