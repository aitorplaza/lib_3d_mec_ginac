...
#define PI 3.14159265358979
	symbol_numeric rho1 = *sys.new_Coordinate("rho1","drho1","ddrho1", 0.3 , 0.0 , 0.0); //Giro eje en z

	symbol_numeric phi1 = *sys.new_Coordinate("phi1","dphi1","ddphi1", 0.3 , 0.0 , 0.0); //Cabeceo plataforma
...
// ************************************************************************************************
	...
	symbol_numeric MomRuedaIzq = *sys.new_Input("MomRuedaIzq",-1.0);
	symbol_numeric MomRuedaDcha = *sys.new_Input("MomRuedaDcha",-1.0);
...
// ************************************************************************************************
	...
	symbol_numeric KMan = *sys.new_Input("KMan",4);
	...
	Vector3D F_Manillar =*sys.new_Vector3D("M_Manillar",0,0,0,"B_Manillar");
