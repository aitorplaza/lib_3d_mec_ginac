...
// ************************************************************************************************
	...
	symbol_numeric y = *sys.new_Coordinate("y","dy","ddy",2.1769,0,0);
	symbol_numeric z = *sys.new_Coordinate("z","dz","ddz",-0.13019,0,0);


        // Initial positions and velocities
	symbol_numeric theta1_0 = *sys.new_Parameter("theta1_0",1.05);
	...
	vel_indep_init	= (*dtheta1-theta1_0), (*dpsi-dpsi_0);
...
// ************************************************************************************************
 	...
 	sys.new_Base("b123","xyz",1,0,0, theta1); //Base arm1
	sys.new_Base("b1'2'3'","xyz",1,0,0, -theta2);//Base arm2
	sys.new_Base("b1''2''3''","xyz",1,0,0, -psi);//Base disc
	sys.new_Base("b1'''2'''3'''","xyz",1,0,0, alpha);//Base plane

// ************************************************************************************************
//	Define Vectors
// ************************************************************************************************

	Vector3D OA = *sys.new_Vector3D("OA",0,l1,0,"b123");
        Vector3D AG = *sys.new_Vector3D("AG",0,l2,0,"b1'2'3'");
...
// ************************************************************************************************
	//viscosity
    	symbol_numeric  Cvis = *sys.new_Parameter("Cvis",0.1);
	...
	Vector3D OArm1_GArm1= *sys.new_Vector3D("OArm1_GArm1",0,l1/2,0,"b123");

    	Tensor3D IArm1 = *sys.new_Tensor3D("IArm1",(ex)I1b1,(ex)0,(ex)0,(ex)0,(ex)0,(ex)0,(ex)0,(ex)0,(ex)I1b1,"b123");
	...
	Vector3D OArm2_GArm2= *sys.new_Vector3D("OArm2_GArm2",0,l2/2,0,"b1'2'3'");

    	Tensor3D IArm2 = *sys.new_Tensor3D("IArm2",(ex)I1b2,(ex)0,(ex)0,(ex)0,(ex)0,(ex)0,(ex)0,(ex)0,(ex)I1b2,"b1'2'3'");
	...
	Vector3D ODisc_GDisc= *sys.new_Vector3D("ODisc_GDisc",0,0,0,"b1''2''3''");

    	Tensor3D IDisc = *sys.new_Tensor3D("IDisc",(ex)IDisc1,(ex)0,(ex)0,(ex)0,(ex)IDisc2,(ex)0,(ex)0,(ex)0,(ex)IDisc3,"b1''2''3''");
	...
	Vector3D OEllipse_GEllipse= *sys.new_Vector3D("OEllipse_GEllipse",0,0,0,"b1''2''3''");
    	Tensor3D IEllipse = *sys.new_Tensor3D("IEllipse",(ex)IEllipse1,(ex)0,(ex)0,(ex)0,(ex)IEllipse2,(ex)0,(ex)0,(ex)0,(ex)IEllipse3,"b1''2''3''");
	#endif
...
// ************************************************************************************************
	...
	Frame * Fra_Arm1 = sys.new_Frame("Fra_Arm1","O","b123");
	Frame * Fra_Arm2=sys.new_Frame("Fra_Arm2","A","b1'2'3'");
	Frame * Fra_Disc=sys.new_Frame("Fra_Disc","G","b1''2''3''");
	Frame * Fra_Plane=sys.new_Frame("Fra_Plane","O1","b1'''2'''3'''");
...
// ************************************************************************************************
	...
	Solid * Arm1 = sys.new_Solid("Arm1","O","b123","mb1","OArm1_GArm1","IArm1");
	Solid * Arm2 = sys.new_Solid("Arm2","A","b1'2'3'","mb2","OArm2_GArm2","IArm2");
	#ifdef DISC 
	Solid * Disc = sys.new_Solid("Disc","G","b1''2''3''","mDisc","ODisc_GDisc","IDisc");
	#elif defined ELLIPSE
	Solid * Ellipse = sys.new_Solid("Ellipse","G","b1''2''3''","mEllipse","OEllipse_GEllipse","IEllipse");
	#endif
...
// ************************************************************************************************
        ...
        Drawing3D * Plane_3D = sys.new_Drawing3D("Plane_3D","Plane","O1","b1'''2'''3'''","./solids/plane.stl",1,0,1,1.0);
	#ifdef DISC 
...
// ************************************************************************************************
	...
	//Viscosity 
	Vector3D MV_Arm1 = -Cvis* sys.Angular_Velocity("xyz" ,"b123" );
	...
	//Link Arm1 - Arm2
	Vector3D Fb1b2 = *sys.new_Vector3D("Fb1b2",0,Fb1b22,Fb1b23,"b123");
	Vector3D Mb1b2 = *sys.new_Vector3D("Mb1b2",0,0,0, "b123");

	//Link Arm2 - Disc
	Vector3D Fb2d = *sys.new_Vector3D("Fb2d",0,Fb2d2,Fb2d3,"b1'2'3'");
	Vector3D Mb2d = *sys.new_Vector3D("Mb2d",0,0,0,"b1'2'3'");

	//Link Plane - Disc/Ellipse
	Vector3D Fsd = *sys.new_Vector3D("Fsd",0,0,Fsd3,"b1'''2'''3'''");
	Vector3D Msd = *sys.new_Vector3D("Msd",0,0,0,"b1'''2'''3'''");
	#endif
...
// ************************************************************************************************
	...
	//Auxiliary vetors
	Vector3D norm_plane = *sys.new_Vector3D("norm_plane",0,0,1,"b1'''2'''3'''");
	Vector3D tan_plane = *sys.new_Vector3D("tan_plane",0,1,0,"b1'''2'''3'''");
	...
	ex Elipse3= 1/(b*b);
        ...
        Tensor3D MElipse = *sys.new_Tensor3D("MElipse",(ex)Elipse1,(ex)0,(ex)0,(ex)0,(ex)Elipse2,(ex)0,(ex)0,(ex)0,(ex)Elipse3,"b1''2''3''");
...
// ************************************************************************************************
	...
	#if METHOD == LAGRANGE
	state = theta1, theta2, psi, y, z, *dtheta1, *dtheta2, *dpsi, *ddtheta1, *ddtheta2, *ddpsi, lambda1,lambda2,lambda3;
	#endif
	#if METHOD == VIRTUAL_POWER
    	state = theta1, theta2, psi, y, z, *dtheta1, *dtheta2, *dpsi, *ddtheta1, *ddtheta2, *ddpsi, Fsb12, Fsb13, Fb1b22, Fb1b23, Fb2d2, Fb2d3, Fsd3;
	#endif
