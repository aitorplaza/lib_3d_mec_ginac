...
MODULES            = mu_div_mod_vel_sliding_vel_wrapper.c rtGetInf.c rtGetNaN.c rt_nonfinite.c train_discrete_firction_noOSG_acc_data.c 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/train_discrete_firction_noOSG \
	-I$(START_DIR) \
