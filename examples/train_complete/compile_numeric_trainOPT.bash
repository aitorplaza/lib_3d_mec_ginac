...
KALKER="CKRFR.c CKRFL.c CKRRR.c CKRRL.c CKFFR.c CKFFL.c CKFRR.c CKFRL.c Delta.c"
CONTACT="Gammac.c Betac.c Phic.c Phit.c dPhic_dq.c dPhit_ds.c dPhit_dq.c" 
