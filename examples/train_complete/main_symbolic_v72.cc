...
// *****************************************************************************************************************	
    ...
    cout << "********************************************************" << endl;
    cout << "*             Train                                    *" << endl;
    cout << "*        COMPLETE v72 SPLINES (cones & cylinders)      *" << endl;
    cout << "********************************************************" << endl;
...
// ************************************************************************************************************************************************************************************************
    ...
    symbol_numeric  zCGWAG = *sys.new_Parameter("zCGWAG",0.0); 
...
cout << "RFR " <<endl;
    ...
    ex splineW_RFR = -uW_RFR*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_RFR = *sys.new_Vector3D("fR_RFR",xR_RFR,rR*sin(uR_RFR),rR*cos(uR_RFR),"B_RAIL");
...
cout << " RFL " <<endl;
    ...
    ex splineW_RFL = uW_RFL*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_RFL = *sys.new_Vector3D("fR_RFL",xR_RFL,rR*sin(uR_RFL),rR*cos(uR_RFL),"B_RAIL");
...
//    ex splineW_RRR =   dW_RRR + sW_RRR * ( cW_RRR + sW_RRR * (bW_RRR + sW_RRR * aW_RRR ) );
    ex splineW_RRR = -uW_RRR*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_RRR = *sys.new_Vector3D("fR_RRR",xR_RRR,rR*sin(uR_RRR),rR*cos(uR_RRR),"B_RAIL");
...
cout << " RRL" <<endl;
    ...
    ex splineW_RRL = uW_RRL*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_RRL = *sys.new_Vector3D("fR_RRL",xR_RRL,rR*sin(uR_RRL),rR*cos(uR_RRL),"B_RAIL");
...
//    ex splineW_FFR =   dW_FFR + sW_FFR * ( cW_FFR + sW_FFR * (bW_FFR + sW_FFR * aW_FFR ) );
    ex splineW_FFR = -uW_FFR*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_FFR = *sys.new_Vector3D("fR_FFR",xR_FFR,rR*sin(uR_FFR),rR*cos(uR_FFR),"B_RAIL");
...
cout << " FFL" <<endl;
    ...
    ex splineW_FFL = uW_FFL*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_FFL = *sys.new_Vector3D("fR_FFL",xR_FFL,rR*sin(uR_FFL),rR*cos(uR_FFL),"B_RAIL");
...
cout << "FRR " <<endl;
    ...
    ex splineW_FRR = -uW_FRR*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_FRR = *sys.new_Vector3D("fR_FRR",xR_FRR,rR*sin(uR_FRR),rR*cos(uR_FRR),"B_RAIL");
...
cout << " FRL" <<endl; 
    ...
    ex splineW_FRL = uW_FRL*((Rw-rw)/Lw)-((Rw+rw)/2.0);  ;
    ...
    Vector3D fR_FRL = *sys.new_Vector3D("fR_FRL",xR_FRL,rR*sin(uR_FRL),rR*cos(uR_FRL),"B_RAIL");
...
// ************************************************************************************************
	...
	cout << "Export State File" << endl;
    	...
    	state = xWAG , yWAG , zWAG , aWAG , bWAG , cWAG , cRSLD , cFSLD , zRBOG , aRBOG , bRBOG , zFBOG , aFBOG , bFBOG , zRWHSF , aRWHSF , bRWHSF , zRWHSR , aRWHSR , bRWHSR , zFWHSF , aFWHSF , bFWHSF , zFWHSR , aFWHSR , bFWHSR , bRAXBFL , bRAXBFR , bRAXBRL , bRAXBRR , bFAXBFL , bFAXBFR , bFAXBRL , bFAXBRR , xRMOTF , yRMOTF , zRMOTF , bRMOTF , xRMOTR , yRMOTR , zRMOTR , bRMOTR , bRROTF , bRROTR; 
