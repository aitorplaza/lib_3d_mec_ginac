...
#COMMON="Declare_Variables.c lin_alg.c time_3D_mec.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Phi.c Beta.c Gamma.c write_data_file.c step.c"
COMMON="Declare_Variables.c time_3D_mec.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Phi.c Beta.c Gamma.c Output.c write_data_file.c step.c"
...
#####################################################################################################################################################
  ...
  if [ "$INTEG" == 1 ];  then
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDL $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDL one_step_euler.c -lm
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDQ $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDQ one_step_euler.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Z $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Z one_step_euler.c -lm
      ./$MAIN $TTIME $TSTEP $name;		
    fi
  fi
  ...
  if [ "$INTEG" == 2 ];  then
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDL $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDL one_step_trapezoidal.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDQ $TRI_LDL $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDQ one_step_trapezoidal.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 3 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Z $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Z one_step_trapezoidal.c -lm
      echo "Executing"
      ./$MAIN $TTIME $TSTEP $name;		
    fi
  fi
...
#####################################################################################################################################################
  ...
  if [ "$INTEG" == 1 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDL $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDL one_step_euler.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $EULER $Q $DDQ $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDQ one_step_euler.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
  ...
  if [ "$INTEG" == 2 ];  then
    ...
    if [ "$FORM" == 1 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDL $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDL one_step_trapezoidal.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
    ...
    if [ "$FORM" == 2 ];  then 
      ...
      gcc -DLIN_ALG -DTIME_OFF $INIT $TRAPEZOIDAL $Q $DDQ $TRI_LU $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDQ one_step_trapezoidal.c -lm
      ./$MAIN $TTIME $TSTEP $name;
    fi
...
###################################################################################################
  ...
  if [ "$FORM" == 1 ] && [ "$INTEG" == 1 ];  then 
    ...
    gcc -DLIN_ALG -DTIME_OFF $EULER $Q $DDL $INV $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDL one_step_euler.c -lm
    ./$MAIN $TTIME $TSTEP $name;
  fi
  if [ "$FORM" == 1 ] && [ "$INTEG" == 2 ];  then 
    ...
    gcc -DLIN_ALG -DTIME_OFF $TRAPEZOIDAL $Q $DDL $INV $TOL $AUX -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $L_A $COORD_Q $DYN_DDL one_step_trapezoidal.c -lm
    ./$MAIN $TTIME $TSTEP $name;
  fi
...
if [ "$MATH" == 4 ];  then
  ...
  if [ "$INTEG" == 1 ];  then
    if [ "$FORM" == 1 ];  then
      ...
      gcc  -DLAPACK -DTIME_OFF $EULER $Q $DDL -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $COORD_Q $DYN_DDL newton_raphson_min_norm.c -lm -lblas -llapack
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 2 ];  then
  ...
  if [ "$INTEG" == 2 ];  then
    if [ "$FORM" == 1 ];  then
      ...
      gcc  -DLAPACK -DTIME_OFF $TRAPEZOIDAL $Q $DDL -O2 -o $MAIN $MAIN.c $COMMON $TRAIN $COORD_Q $DYN_DDL newton_raphson_min_norm.c -lm -lblas -llapack
      ./$MAIN $TTIME $TSTEP $name;
    fi
    if [ "$FORM" == 2 ];  then
