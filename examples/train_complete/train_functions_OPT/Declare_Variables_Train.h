...
#define n_coord_indep ( n_gen_coord + n_gen_auxcoord - n_coord_dep)
#define n_vel_dep Beta_n_rows
#define n_vel_indep (n_gen_vel + n_gen_auxvel - n_vel_dep)
#define n_accel_dep Gamma_n_rows
#define n_accel_indep (n_gen_accel +n_gen_auxaccel  - n_accel_dep)
