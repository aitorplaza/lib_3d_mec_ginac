...
cout << " RFR " <<endl;
    ...
    symbol_numeric thetaW_RFR = *sys.new_Coordinate("thetaW_RFR","dthetaW_RFR","ddthetaW_RFR",0.048135,0.0,0.0);
    symbol_numeric uW_RFR = *sys.new_Coordinate("uW_RFR","duW_RFR","dduW_RFR",-0.0104279,0.0,0.0);
    ...
    symbol_numeric uR_RFR = *sys.new_Coordinate("uR_RFR","duR_RFR","dduR_RFR", -0.00842799 ,0.0,0.0);
    symbol_numeric xR_RFR = *sys.new_Coordinate("xR_RFR","dxR_RFR","ddxR_RFR", -3.65595 ,0.0,0.0);
...
cout << " RFL " <<endl;
    ...
    symbol_numeric thetaW_RFL = *sys.new_Coordinate("thetaW_RFL","dthetaW_RFL","ddthetaW_RFL",0.048135,0.0,0.0);
    symbol_numeric uW_RFL = *sys.new_Coordinate("uW_RFL","duW_RFL","dduW_RFL",0.010428,0.0,0.0);
    ...
    symbol_numeric uR_RFL = *sys.new_Coordinate("uR_RFL","duR_RFL","dduR_RFL", 0.00842792 ,0.0,0.0);
    symbol_numeric xR_RFL = *sys.new_Coordinate("xR_RFL","dxR_RFL","ddxR_RFL", -3.65595 ,0.0,0.0);
...
cout << " RRR" <<endl;
    ...
    symbol_numeric thetaW_RRR = *sys.new_Coordinate("thetaW_RRR","dthetaW_RRR","ddthetaW_RRR",0.048135,0.0,0.0);
    symbol_numeric uW_RRR = *sys.new_Coordinate("uW_RRR","duW_RRR","dduW_RRR",-0.0104279,0.0,0.0);
    ...
    symbol_numeric uR_RRR = *sys.new_Coordinate("uR_RRR","duR_RRR","dduR_RRR", -0.00842799 ,0.0,0.0);
    symbol_numeric xR_RRR = *sys.new_Coordinate("xR_RRR","dxR_RRR","ddxR_RRR", -5.84095 ,0.0,0.0);
...
cout << " RRL" <<endl;
    ...
    symbol_numeric thetaW_RRL = *sys.new_Coordinate("thetaW_RRL","dthetaW_RRL","ddthetaW_RRL",0.048135,0.0,0.0);
    symbol_numeric uW_RRL = *sys.new_Coordinate("uW_RRL","duW_RRL","dduW_RRL",0.010428,0.0,0.0);
    ...
    symbol_numeric uR_RRL = *sys.new_Coordinate("uR_RRL","duR_RRL","dduR_RRL", 0.00842792 ,0.0,0.0);
    symbol_numeric xR_RRL = *sys.new_Coordinate("xR_RRL","dxR_RRL","ddxR_RRL", -5.84095 ,0.0,0.0);
...
cout << " FFR" <<endl;   
    ...
    symbol_numeric thetaW_FFR = *sys.new_Coordinate("thetaW_FFR","dthetaW_FFR","ddthetaW_FFR",-0.0642612,0.0,0.0);
    symbol_numeric uW_FFR = *sys.new_Coordinate("uW_FFR","duW_FFR","dduW_FFR",-0.0104288,0.0,0.0);
    ...
    symbol_numeric uR_FFR = *sys.new_Coordinate("uR_FFR","duR_FFR","dduR_FFR", -0.00842853 ,0.0,0.0);
    symbol_numeric xR_FFR = *sys.new_Coordinate("xR_FFR","dxR_FFR","ddxR_FFR", 5.84404 ,0.0,0.0);
...
cout << " FFL" <<endl;
    ...
    symbol_numeric thetaW_FFL = *sys.new_Coordinate("thetaW_FFL","dthetaW_FFL","ddthetaW_FFL",-0.0642612,0.0,0.0);
    symbol_numeric uW_FFL = *sys.new_Coordinate("uW_FFL","duW_FFL","dduW_FFL",0.0104271,0.0,0.0);
    ...
    symbol_numeric uR_FFL = *sys.new_Coordinate("uR_FFL","duR_FFL","dduR_FFL", 0.00842738 ,0.0,0.0);
    symbol_numeric xR_FFL = *sys.new_Coordinate("xR_FFL","dxR_FFL","ddxR_FFL", 5.84404 ,0.0,0.0);
...
cout << " FRR " <<endl;
    ...
    symbol_numeric thetaW_FRR = *sys.new_Coordinate("thetaW_FRR","dthetaW_FRR","ddthetaW_FRR",-0.0642611,0.0,0.0);
    symbol_numeric uW_FRR = *sys.new_Coordinate("uW_FRR","duW_FRR","dduW_FRR",-0.0104268,0.0,0.0);
    ...
    symbol_numeric uR_FRR = *sys.new_Coordinate("uR_FRR","duR_FRR","dduR_FRR", -0.00842737 ,0.0,0.0);
    symbol_numeric xR_FRR = *sys.new_Coordinate("xR_FRR","dxR_FRR","ddxR_FRR", 3.65904,0.0,0.0);
...
cout << " FRL" <<endl; 
    ...
    symbol_numeric thetaW_FRL = *sys.new_Coordinate("thetaW_FRL","dthetaW_FRL","ddthetaW_FRL",-0.0642611,0.0,0.0);
    symbol_numeric uW_FRL = *sys.new_Coordinate("uW_FRL","duW_FRL","dduW_FRL",0.0104291,0.0,0.0);
    ...
    symbol_numeric uR_FRL = *sys.new_Coordinate("uR_FRL","duR_FRL","dduR_FRL", 0.00842854 ,0.0,0.0);
    symbol_numeric xR_FRL = *sys.new_Coordinate("xR_FRL","dxR_FRL","ddxR_FRL", 3.65904 ,0.0,0.0);
...
// ************************************************************************************************
    ...
    //atrix Dynamic_Equations(0,0);
    
// ************************************************************************************************
// 	Equilibrium problem
// ************************************************************************************************
/*    Matrix Equlibrium(Dynamic_Equations.rows(),1)cd;

    symbol_numeric *dq_j;
    symbol_numeric *ddq_j;
    for (int i=0; (i < Dynamic_Equations.rows()); ++i) {
        for (int j=0; (j < Velocities.size()); ++j) {
            dq_j=Velocities[j];
            ddq_j=Accelerations[j];
            Equlibrium(i,0)=Dynamic_Equations(i,0).subs((*dq_j)==0);
...
// ************************************************************************************************
    ...
    symbol_numeric Hertz_a = *sys.new_Parameter("Hertz_a",0.0);
    symbol_numeric Hertz_b = *sys.new_Parameter("Hertz_b",0.0);  
...
// ************************************************************************************************
	...
	cout << "Export State File" << endl;
    	...
    	state = xWAG , yWAG , zWAG , aWAG , bWAG , cWAG , cRSLD , cFSLD , zRBOG , aRBOG , bRBOG , zFBOG , aFBOG , bFBOG , zRWHSF , aRWHSF , bRWHSF , zRWHSR , aRWHSR , bRWHSR , zFWHSF , aFWHSF , bFWHSF , zFWHSR , aFWHSR , bFWHSR ,
                ...
                thetaW_RFR, uW_RFR, uR_RFR, xR_RFR, thetaW_RFL, uW_RFL, uR_RFL, xR_RFL, thetaW_RRR, uW_RRR, uR_RRR, xR_RRR, thetaW_RRL, uW_RRL, uR_RRL, xR_RRL, thetaW_FFR, uW_FFR, uR_FFR, xR_FFR, thetaW_FFL, uW_FFL, uR_FFL, xR_FFL, thetaW_FRR, uW_FRR, uR_FRR, xR_FRR, thetaW_FRL, uW_FRL, uR_FRL, xR_FRL                
                ; 
