...
// ************************************************************************************************
    symbol_numeric xWAG = *sys.new_Coordinate("xWAG","dxWAG","ddxWAG", 0.0,0.0,0.0);
    symbol_numeric yWAG = *sys.new_Coordinate("yWAG","dyWAG","ddyWAG", 0.0,0.0,0.0);
    symbol_numeric zWAG = *sys.new_Coordinate("zWAG","dzWAG","ddzWAG", 0.0,0.0,0.0);
    symbol_numeric aWAG = *sys.new_Coordinate("aWAG","daWAG","ddaWAG",-0.0,0.0,0.0);
    symbol_numeric bWAG = *sys.new_Coordinate("bWAG","dbWAG","ddbWAG",-0.0,0.0,0.0);
    ...
    symbol_numeric zRBOG = *sys.new_Coordinate("zRBOG","dzRBOG","ddzRBOG",0.0,0.0,0.0);
    symbol_numeric aRBOG = *sys.new_Coordinate("aRBOG","daRBOG","ddaRBOG", 0.0,0.0,0.0);
    symbol_numeric bRBOG = *sys.new_Coordinate("bRBOG","dbRBOG","ddbRBOG", 0.0,0.0,0.0);
    ...
    symbol_numeric zFBOG = *sys.new_Coordinate("zFBOG","dzFBOG","ddzFBOG",0.0,0.0,0.0);
    symbol_numeric aFBOG = *sys.new_Coordinate("aFBOG","daFBOG","ddaFBOG", 0.0,0.0,0.0);
    symbol_numeric bFBOG = *sys.new_Coordinate("bFBOG","dbFBOG","ddbFBOG", 0.0,0.0,0.0);
    ...
    symbol_numeric zRWHSF = *sys.new_Coordinate("zRWHSF","dzRWHSF","ddzRWHSF",0.0,0.0,0.0);
    symbol_numeric aRWHSF = *sys.new_Coordinate("aRWHSF","daRWHSF","ddaRWHSF",0.0,0.0,0.0);
    symbol_numeric bRWHSF = *sys.new_Coordinate("bRWHSF","dbRWHSF","ddbRWHSF",0.0,0.0,0.0);
    ...
    symbol_numeric zRWHSR = *sys.new_Coordinate("zRWHSR","dzRWHSR","ddzRWHSR",0.0,0.0,0.0);
    symbol_numeric aRWHSR = *sys.new_Coordinate("aRWHSR","daRWHSR","ddaRWHSR",0.0,0.0,0.0);
    symbol_numeric bRWHSR = *sys.new_Coordinate("bRWHSR","dbRWHSR","ddbRWHSR",0.0,0.0,0.0);
    ...
    symbol_numeric zFWHSF = *sys.new_Coordinate("zFWHSF","dzFWHSF","ddzFWHSF",0.0,0.0,0.0);
    symbol_numeric aFWHSF = *sys.new_Coordinate("aFWHSF","daFWHSF","ddaFWHSF",0.0,0.0,0.0);
    symbol_numeric bFWHSF = *sys.new_Coordinate("bFWHSF","dbFWHSF","ddbFWHSF",0.0,0.0,0.0);
    ...
    symbol_numeric zFWHSR = *sys.new_Coordinate("zFWHSR","dzFWHSR","ddzFWHSR",0.0,0.0,0.0);
    symbol_numeric aFWHSR = *sys.new_Coordinate("aFWHSR","daFWHSR","ddaFWHSR",0.0,0.0,0.0);
    symbol_numeric bFWHSR = *sys.new_Coordinate("bFWHSR","dbFWHSR","ddbFWHSR",0.0,0.0,0.0);
    ...
    symbol_numeric zRMOTF = *sys.new_Coordinate("zRMOTF","dzRMOTF","ddzRMOTF",0.0,0.0,0.0);
    symbol_numeric bRMOTF = *sys.new_Coordinate("bRMOTF","dbRMOTF","ddbRMOTF", 0.0,0.0,0.0);
    ...
    symbol_numeric zRMOTR = *sys.new_Coordinate("zRMOTR","dzRMOTR","ddzRMOTR",0.0,0.0,0.0);
    symbol_numeric bRMOTR = *sys.new_Coordinate("bRMOTR","dbRMOTR","ddbRMOTR",0.0,0.0,0.0);
    ...
    //FRONT ROTOR (RROTF)
    symbol_numeric bRROTF = *sys.new_Coordinate("bRROTF","dbRROTF","ddbRROTF",0.0 ,0.0,0.0);
    symbol_numeric *dbRROTF=sys.get_Velocity("dbRROTF");
    symbol_numeric *ddbRROTF=sys.get_Acceleration("ddbRROTF");
    
    //REAR RROTOR (RROTR)   
    symbol_numeric bRROTR = *sys.new_Coordinate("bRROTR","dbRROTR","ddbRROTR",0.0,0.0,0.0);
...
// ************************************************************************************************************************************************************************************************
    ...
    symbol_numeric L_WHS          = *sys.new_Parameter("L_WHS",0.930+0.068+0.068+0.00);//1.0660
...
cout << "RFR " <<endl;
    ...
    Vector3D ORWHSF_OWRFR   = *sys.new_Vector3D("ORWHSF_OWRFR", 0,-L_WHS/2.0,0,"B_RWHSF"); 
    Point * O_WRFR  = sys.new_Point("O_WRFR","O_RWHSF",&ORWHSF_OWRFR);

    symbol_numeric thetaW_RFR = *sys.new_Coordinate("thetaW_RFR","dthetaW_RFR","ddthetaW_RFR",0.0,0.0,0.0);
    symbol_numeric uW_RFR = *sys.new_Coordinate("uW_RFR","duW_RFR","dduW_RFR",0.0,0.0,0.0);

    symbol_numeric aW_RFR = *sys.new_Parameter("aW_RFR",0.006456790834618e+4);//spline's coefficients
    symbol_numeric bW_RFR = *sys.new_Parameter("bW_RFR",-0.000002379249587e+4);
    symbol_numeric cW_RFR = *sys.new_Parameter("cW_RFR",0.000000893613412e+4);
    symbol_numeric dW_RFR = *sys.new_Parameter("dW_RFR",-0.000050000000000e+4);
    symbol_numeric lW_RFR = *sys.new_Parameter("lW_RFR",0.01);//size of the spline

    ex sW_RFR = uW_RFR - lW_RFR;
    ex splineW_RFR =   dW_RFR + sW_RFR * ( cW_RFR + sW_RFR * (bW_RFR + sW_RFR * aW_RFR ) );
    Vector3D fW_RFR = *sys.new_Vector3D("fW_RFR",-splineW_RFR*sin(thetaW_RFR),uW_RFR,splineW_RFR*cos(thetaW_RFR),"B_RWHSF");
    ...
    symbol_numeric uR_RFR = *sys.new_Coordinate("uR_RFR","duR_RFR","dduR_RFR", 0.0 ,0.0,0.0);
    symbol_numeric xR_RFR = *sys.new_Coordinate("xR_RFR","dxR_RFR","ddxR_RFR", 0.0 ,0.0,0.0);

    symbol_numeric aR_RFR = *sys.new_Parameter("aR_RFR",0.066403345669996e+3);//spline's coefficients right wheel
    symbol_numeric bR_RFR = *sys.new_Parameter("bR_RFR",-0.001998816728350e+3);
    symbol_numeric cR_RFR = *sys.new_Parameter("cR_RFR",0.000000000000000e+3);
    symbol_numeric dR_RFR = *sys.new_Parameter("dR_RFR",0.000159000000000e+3);
    symbol_numeric lR_RFR = *sys.new_Parameter("lR_RFR",0.005); //size of the spline 
    ...
    Vector3D rR_RFR = sys.Position_Vector("O","O_RailL")+fR_RFR;
    ...
    Point * Pcon_RFR   = sys.new_Point("Pcon_RFR","O",&rW_RFR);

    Vector3D FKALKER_RFR = (Fx_RFR* u_t1R_RFR) + (Fy_RFR * u_t2R_RFR);
    Vector3D MKALKER_RFR = Mz_RFR * u_nR_RFR;

    Wrench3D * FKalker_RFR = sys.new_Wrench3D ( "FKalker_RFR", FKALKER_RFR, MKALKER_RFR , Pcon_RFR, RWHSF , "Constitutive") ;

    Phi(0,0) = u_t1R_RFR * (rW_RFR-rR_RFR);
    Phi(1,0) = u_t2R_RFR * (rW_RFR-rR_RFR);
    Phi(2,0) = u_nR_RFR  * (rW_RFR-rR_RFR);
    Phi(3,0) = u_nR_RFR*t1W_RFR;
    Phi(4,0) = u_nR_RFR*t2W_RFR;
cout <<"fR_RFR= "<< fR_RFR<<endl;
cout <<"rR_RFR= "<< rR_RFR<<endl;
cout <<"t1R_RFR= "<< t1R_RFR<<endl;
cout <<"t2R_RFR= "<< t2R_RFR<<endl;
cout <<"nR_RFR= "<< nR_RFR<<endl;
cout <<"u_nR_RFR = "<<u_nR_RFR <<endl;
cout <<"u_t1R_RFR = "<< u_t1R_RFR<<endl;
cout <<"u_t2R_RFR = "<< u_t2R_RFR<<endl;
cout <<"Phi(3,0)= "<<Phi(3,0) <<endl;
cout <<"Phi(4,0)= "<< Phi(4,0)<<endl;
...
cout << "RFL " <<endl;
    ...
    Vector3D ORWHSF_OWRFL   = *sys.new_Vector3D("ORWHSF_OWRFL", 0,+L_WHS/2.0,0,"B_RWHSF"); 
    Point * O_WRFL  = sys.new_Point("O_WRFL","O_RWHSF",&ORWHSF_OWRFL);

    symbol_numeric thetaW_RFL = *sys.new_Coordinate("thetaW_RFL","dthetaW_RFL","ddthetaW_RFL",0.0,0.0,0.0);
    symbol_numeric uW_RFL = *sys.new_Coordinate("uW_RFL","duW_RFL","dduW_RFL",0.0,0.0,0.0);

    symbol_numeric aW_RFL = *sys.new_Parameter("aW_RFL",-0.005980940917141e+4);//spline's coefficients
    symbol_numeric bW_RFL = *sys.new_Parameter("bW_RFL",-0.000002379249587e+4);
    symbol_numeric cW_RFL = *sys.new_Parameter("cW_RFL",-0.000000893613412e+4);
    symbol_numeric dW_RFL = *sys.new_Parameter("dW_RFL",-0.000050000000000e+4);
    symbol_numeric lW_RFL = *sys.new_Parameter("lW_RFL",0.01);//size of the spline

    ex sW_RFL = uW_RFL - lW_RFL;
    ex splineW_RFL =   dW_RFL + sW_RFL * ( cW_RFL + sW_RFL * (bW_RFL + sW_RFL * aW_RFL ) );
    Vector3D fW_RFL = *sys.new_Vector3D("fW_RFL",-splineW_RFL*sin(thetaW_RFL),uW_RFL,splineW_RFL*cos(thetaW_RFL),"B_RWHSF");
    ...
    symbol_numeric uR_RFL = *sys.new_Coordinate("uR_RFL","duR_RFL","dduR_RFL", 0.0 ,0.0,0.0);
    symbol_numeric xR_RFL = *sys.new_Coordinate("xR_RFL","dxR_RFL","ddxR_RFL", 0.0 ,0.0,0.0);

    symbol_numeric aR_RFL = *sys.new_Parameter("aR_RFL",0.066403345669996e+3);//spline's coefficients 
    symbol_numeric bR_RFL = *sys.new_Parameter("bR_RFL",-0.001998816728350e+3);
    symbol_numeric cR_RFL = *sys.new_Parameter("cR_RFL",0.000000000000000e+3);
    symbol_numeric dR_RFL = *sys.new_Parameter("dR_RFL",0.000159000000000e+3);
    symbol_numeric lR_RFL = *sys.new_Parameter("lR_RFL",0.005); //size of the spline 
    ...
    Point * Pcon_RFL   = sys.new_Point("Pcon_RFL","O",&rW_RFL);

    Vector3D FKALKER_RFL = (Fx_RFL* u_t1R_RFL) + (Fy_RFL * u_t2R_RFL);
    Vector3D MKALKER_RFL = Mz_RFL * u_nR_RFL;

    Wrench3D * FKalker_RFL = sys.new_Wrench3D ( "FKalker_RFL", FKALKER_RFL, MKALKER_RFL , Pcon_RFL, RWHSF , "Constitutive") ;

    Phi(5,0) = u_t1R_RFL * (rW_RFL-rR_RFL);
    Phi(6,0) = u_t2R_RFL * (rW_RFL-rR_RFL);
    Phi(7,0) = u_nR_RFL  * (rW_RFL-rR_RFL);
...
cout << " RRR" <<endl;
    ...
    Vector3D ORWHSR_OWRRR   = *sys.new_Vector3D("ORWHSR_OWRRR", 0,-L_WHS/2.0,0,"B_RWHSR"); 
    Point * O_WRRR  = sys.new_Point("O_WRRR","O_RWHSR",&ORWHSR_OWRRR);

    symbol_numeric thetaW_RRR = *sys.new_Coordinate("thetaW_RRR","dthetaW_RRR","ddthetaW_RRR",0.0,0.0,0.0);
    symbol_numeric uW_RRR = *sys.new_Coordinate("uW_RRR","duW_RRR","dduW_RRR",0.0,0.0,0.0);

    symbol_numeric aW_RRR = *sys.new_Parameter("aW_RRR",0.006456790834618e+4);//spline's coefficients
    symbol_numeric bW_RRR = *sys.new_Parameter("bW_RRR",-0.000002379249587e+4);
    symbol_numeric cW_RRR = *sys.new_Parameter("cW_RRR",0.000000893613412e+4);
    symbol_numeric dW_RRR = *sys.new_Parameter("dW_RRR",-0.000050000000000e+4);
    symbol_numeric lW_RRR = *sys.new_Parameter("lW_RRR",0.01);//size of the spline

    ex sW_RRR = uW_RRR - lW_RRR;
    ex splineW_RRR =   dW_RRR + sW_RRR * ( cW_RRR + sW_RRR * (bW_RRR + sW_RRR * aW_RRR ) );
    Vector3D fW_RRR = *sys.new_Vector3D("fW_RRR",-splineW_RRR*sin(thetaW_RRR),uW_RRR,splineW_RRR*cos(thetaW_RRR),"B_RWHSR");
    ...
    symbol_numeric uR_RRR = *sys.new_Coordinate("uR_RRR","duR_RRR","dduR_RRR", 0.0 ,0.0,0.0);
    symbol_numeric xR_RRR = *sys.new_Coordinate("xR_RRR","dxR_RRR","ddxR_RRR", 0.0 ,0.0,0.0);

    symbol_numeric aR_RRR = *sys.new_Parameter("aR_RRR",0.066403345669996e+3);//spline's coefficients right wheel
    symbol_numeric bR_RRR = *sys.new_Parameter("bR_RRR",-0.001998816728350e+3);
    symbol_numeric cR_RRR = *sys.new_Parameter("cR_RRR",0.000000000000000e+3);
    symbol_numeric dR_RRR = *sys.new_Parameter("dR_RRR",0.000159000000000e+3);
    symbol_numeric lR_RRR = *sys.new_Parameter("lR_RRR",0.005); //size of the spline 
    ...
    Vector3D rR_RRR = sys.Position_Vector("O","O_RailL")+fR_RRR;
    ...
    Phi(10,0) = u_t1R_RRR * (rW_RRR-rR_RRR);
    Phi(11,0) = u_t2R_RRR * (rW_RRR-rR_RRR);
    Phi(12,0) = u_nR_RRR  * (rW_RRR-rR_RRR);
    Phi(13,0) = u_nR_RRR * t1W_RRR;
    Phi(14,0) = u_nR_RRR * t2W_RRR;

    Point * Pcon_RRR   = sys.new_Point("Pcon_RRR","O",&rW_RRR);

    Vector3D FKALKER_RRR = (Fx_RRR* u_t1R_RRR) + (Fy_RRR * u_t2R_RRR);
    Vector3D MKALKER_RRR = Mz_RRR * u_nR_RRR;

    Wrench3D * FKalker_RRR = sys.new_Wrench3D ( "FKalker_RRR", FKALKER_RRR, MKALKER_RRR , Pcon_RRR, RWHSR , "Constitutive") ;
...
cout << " RRL" <<endl;
    ...
    Vector3D ORWHSR_OWRRL   = *sys.new_Vector3D("ORWHSR_OWRRL", 0,+L_WHS/2.0,0,"B_RWHSR"); 
    Point * O_WRRL  = sys.new_Point("O_WRRL","O_RWHSR",&ORWHSR_OWRRL);

    symbol_numeric thetaW_RRL = *sys.new_Coordinate("thetaW_RRL","dthetaW_RRL","ddthetaW_RRL",0.0,0.0,0.0);
    symbol_numeric uW_RRL = *sys.new_Coordinate("uW_RRL","duW_RRL","dduW_RRL",0.0,0.0,0.0);

    symbol_numeric aW_RRL = *sys.new_Parameter("aW_RRL",-0.005980940917141e+4);//spline's coefficients
    symbol_numeric bW_RRL = *sys.new_Parameter("bW_RRL",-0.000002379249587e+4);
    symbol_numeric cW_RRL = *sys.new_Parameter("cW_RRL",-0.000000893613412e+4);
    symbol_numeric dW_RRL = *sys.new_Parameter("dW_RRL",-0.000050000000000e+4);
    symbol_numeric lW_RRL = *sys.new_Parameter("lW_RRL",0.01);//size of the spline

    ex sW_RRL = uW_RRL - lW_RRL;
    ex splineW_RRL =   dW_RRL + sW_RRL * ( cW_RRL + sW_RRL * (bW_RRL + sW_RRL * aW_RRL ) );
    Vector3D fW_RRL = *sys.new_Vector3D("fW_RRL",-splineW_RRL*sin(thetaW_RRL),uW_RRL,splineW_RRL*cos(thetaW_RRL),"B_RWHSR");
    ...
    symbol_numeric uR_RRL = *sys.new_Coordinate("uR_RRL","duR_RRL","dduR_RRL", 0.0 ,0.0,0.0);
    symbol_numeric xR_RRL = *sys.new_Coordinate("xR_RRL","dxR_RRL","ddxR_RRL", 0.0 ,0.0,0.0);

    symbol_numeric aR_RRL = *sys.new_Parameter("aR_RRL",0.066403345669996e+3);//spline's coefficients left wheel
    symbol_numeric bR_RRL = *sys.new_Parameter("bR_RRL",-0.001998816728350e+3);
    symbol_numeric cR_RRL = *sys.new_Parameter("cR_RRL",0.000000000000000e+3);
    symbol_numeric dR_RRL = *sys.new_Parameter("dR_RRL",0.000159000000000e+3);
    symbol_numeric lR_RRL = *sys.new_Parameter("lR_RRL",0.005); //size of the spline 
    ...
    Phi(15,0) = u_t1R_RRL * (rW_RRL-rR_RRL);
    Phi(16,0) = u_t2R_RRL * (rW_RRL-rR_RRL);
    Phi(17,0) = u_nR_RRL  * (rW_RRL-rR_RRL);
    Phi(18,0) = u_nR_RRL * t1W_RRL;
    Phi(19,0) = u_nR_RRL * t2W_RRL;

    Point * Pcon_RRL   = sys.new_Point("Pcon_RRL","O",&rW_RRL);

    Vector3D FKALKER_RRL = (Fx_RRL* u_t1R_RRL) + (Fy_RRL * u_t2R_RRL);
    Vector3D MKALKER_RRL = Mz_RRL * u_nR_RRL;

    Wrench3D * FKalker_RRL = sys.new_Wrench3D ( "FKalker_RRL", FKALKER_RRL, MKALKER_RRL , Pcon_RRL, RWHSR , "Constitutive") ;
...
cout << " FFR" <<endl;   
    ...
    Vector3D OFWHSF_OWFFR   = *sys.new_Vector3D("OFWHSF_OWFFR", 0,-L_WHS/2.0,0,"B_FWHSF"); 
    Point * O_WFFR  = sys.new_Point("O_WFFR","O_FWHSF",&OFWHSF_OWFFR);

    symbol_numeric thetaW_FFR = *sys.new_Coordinate("thetaW_FFR","dthetaW_FFR","ddthetaW_FFR",0.0,0.0,0.0);
    symbol_numeric uW_FFR = *sys.new_Coordinate("uW_FFR","duW_FFR","dduW_FFR",0.0,0.0,0.0);

    symbol_numeric aW_FFR = *sys.new_Parameter("aW_FFR",0.006456790834618e+4);//spline's coefficients
    symbol_numeric bW_FFR = *sys.new_Parameter("bW_FFR",-0.000002379249587e+4);
    symbol_numeric cW_FFR = *sys.new_Parameter("cW_FFR",0.000000893613412e+4);
    symbol_numeric dW_FFR = *sys.new_Parameter("dW_FFR",-0.000050000000000e+4);
    symbol_numeric lW_FFR = *sys.new_Parameter("lW_FFR",0.01);//size of the spline

    ex sW_FFR = uW_FFR - lW_FFR;
    ex splineW_FFR =   dW_FFR + sW_FFR * ( cW_FFR + sW_FFR * (bW_FFR + sW_FFR * aW_FFR ) );
    Vector3D fW_FFR = *sys.new_Vector3D("fW_FFR",-splineW_FFR*sin(thetaW_FFR),uW_FFR,splineW_FFR*cos(thetaW_FFR),"B_FWHSF");
    ...
    symbol_numeric uR_FFR = *sys.new_Coordinate("uR_FFR","duR_FFR","dduR_FFR", 0.0 ,0.0,0.0);
    symbol_numeric xR_FFR = *sys.new_Coordinate("xR_FFR","dxR_FFR","ddxR_FFR", 0.0 ,0.0,0.0);

    symbol_numeric aR_FFR = *sys.new_Parameter("aR_FFR",0.066403345669996e+3);//spline's coefficients right wheel
    symbol_numeric bR_FFR = *sys.new_Parameter("bR_FFR",-0.001998816728350e+3);
    symbol_numeric cR_FFR = *sys.new_Parameter("cR_FFR",0.000000000000000e+3);
    symbol_numeric dR_FFR = *sys.new_Parameter("dR_FFR",0.000159000000000e+3);
    symbol_numeric lR_FFR = *sys.new_Parameter("lR_FFR",0.005); //size of the spline 
    ...
    Vector3D rR_FFR = sys.Position_Vector("O","O_RailL")+fR_FFR;
    ...
    Phi(20,0) = u_t1R_FFR * (rW_FFR-rR_FFR);
    Phi(21,0) = u_t2R_FFR * (rW_FFR-rR_FFR);
    Phi(22,0) = u_nR_FFR  * (rW_FFR-rR_FFR);
    Phi(23,0) = u_nR_FFR * t1W_FFR;
    Phi(24,0) = u_nR_FFR * t2W_FFR;


    Point * Pcon_FFR   = sys.new_Point("Pcon_FFR","O",&rW_FFR);

    Vector3D FKALKER_FFR = (Fx_FFR* u_t1R_FFR) + (Fy_FFR * u_t2R_FFR);
    Vector3D MKALKER_FFR = Mz_FFR * u_nR_FFR;

    Wrench3D * FKalker_FFR = sys.new_Wrench3D ( "FKalker_FFR", FKALKER_FFR, MKALKER_FFR , Pcon_FFR, FWHSF , "Constitutive") ;
...
cout << " FFL" <<endl;
    ...
    Vector3D OFWHSF_OWFFL   = *sys.new_Vector3D("OFWHSF_OWFFL", 0,L_WHS/2.0,0,"B_FWHSF"); 
    Point * O_WFFL  = sys.new_Point("O_WFFL","O_FWHSF",&OFWHSF_OWFFL);

    symbol_numeric thetaW_FFL = *sys.new_Coordinate("thetaW_FFL","dthetaW_FFL","ddthetaW_FFL",0.0,0.0,0.0);
    symbol_numeric uW_FFL = *sys.new_Coordinate("uW_FFL","duW_FFL","dduW_FFL",0.0,0.0,0.0);

    symbol_numeric aW_FFL = *sys.new_Parameter("aW_FFL",-0.005980940917141e+4);//spline's coefficients
    symbol_numeric bW_FFL = *sys.new_Parameter("bW_FFL",-0.000002379249587e+4);
    symbol_numeric cW_FFL = *sys.new_Parameter("cW_FFL",-0.000000893613412e+4);
    symbol_numeric dW_FFL = *sys.new_Parameter("dW_FFL",-0.000050000000000e+4);
    symbol_numeric lW_FFL = *sys.new_Parameter("lW_FFL",0.01);//size of the spline
 
    ex sW_FFL = uW_FFL - lW_FFL;
    ex splineW_FFL =   dW_FFL + sW_FFL * ( cW_FFL + sW_FFL * (bW_FFL + sW_FFL * aW_FFL ) );
    Vector3D fW_FFL = *sys.new_Vector3D("fW_FFL",-splineW_FFL*sin(thetaW_FFL),uW_FFL,splineW_FFL*cos(thetaW_FFL),"B_FWHSF");
    ...
    symbol_numeric uR_FFL = *sys.new_Coordinate("uR_FFL","duR_FFL","dduR_FFL", 0.0 ,0.0,0.0);
    symbol_numeric xR_FFL = *sys.new_Coordinate("xR_FFL","dxR_FFL","ddxR_FFL", 0.0 ,0.0,0.0);

    symbol_numeric aR_FFL = *sys.new_Parameter("aR_FFL",0.066403345669996e+3);//spline's coefficients 
    symbol_numeric bR_FFL = *sys.new_Parameter("bR_FFL",-0.001998816728350e+3);
    symbol_numeric cR_FFL = *sys.new_Parameter("cR_FFL",0.000000000000000e+3);
    symbol_numeric dR_FFL = *sys.new_Parameter("dR_FFL",0.000159000000000e+3);
    symbol_numeric lR_FFL = *sys.new_Parameter("lR_FFL",0.005); //size of the spline 
    ...
    Phi(25,0) = u_t1R_FFL * (rW_FFL-rR_FFL);
    Phi(26,0) = u_t2R_FFL * (rW_FFL-rR_FFL);
    Phi(27,0) = u_nR_FFL  * (rW_FFL-rR_FFL);
    Phi(28,0) = u_nR_FFL * t1W_FFL;
    Phi(29,0) = u_nR_FFL * t2W_FFL;

    Point * Pcon_FFL   = sys.new_Point("Pcon_FFL","O",&rW_FFL);

    Vector3D FKALKER_FFL = (Fx_FFL* u_t1R_FFL) + (Fy_FFL * u_t2R_FFL);
    Vector3D MKALKER_FFL = Mz_FFL * u_nR_FFL;

    Wrench3D * FKalker_FFL = sys.new_Wrench3D ( "FKalker_FFL", FKALKER_FFL, MKALKER_FFL , Pcon_FFL, FWHSF , "Constitutive") ;
...
cout << "FRR " <<endl;
    ...
    Vector3D OFWHSR_OWFRR   = *sys.new_Vector3D("OFWHSR_OWFRR", 0,-L_WHS/2.0,0,"B_FWHSR"); 
    Point * O_WFRR  = sys.new_Point("O_WFRR","O_FWHSR",&OFWHSR_OWFRR);

    symbol_numeric thetaW_FRR = *sys.new_Coordinate("thetaW_FRR","dthetaW_FRR","ddthetaW_FRR",0.0,0.0,0.0);
    symbol_numeric uW_FRR = *sys.new_Coordinate("uW_FRR","duW_FRR","dduW_FRR",0.0,0.0,0.0);

    symbol_numeric aW_FRR = *sys.new_Parameter("aW_FRR",0.006456790834618e+4);//spline's coefficients
    symbol_numeric bW_FRR = *sys.new_Parameter("bW_FRR",-0.000002379249587e+4);
    symbol_numeric cW_FRR = *sys.new_Parameter("cW_FRR",0.000000893613412e+4);
    symbol_numeric dW_FRR = *sys.new_Parameter("dW_FRR",-0.000050000000000e+4);
    symbol_numeric lW_FRR = *sys.new_Parameter("lW_FRR",0.01);//size of the spline

    ex sW_FRR = uW_FRR - lW_FRR;
    ex splineW_FRR =   dW_FRR + sW_FRR * ( cW_FRR + sW_FRR * (bW_FRR + sW_FRR * aW_FRR ) );
    Vector3D fW_FRR = *sys.new_Vector3D("fW_FRR",-splineW_FRR*sin(thetaW_FRR),uW_FRR,splineW_FRR*cos(thetaW_FRR),"B_FWHSR");
    ...
    symbol_numeric uR_FRR = *sys.new_Coordinate("uR_FRR","duR_FRR","dduR_FRR", 0.0 ,0.0,0.0);
    symbol_numeric xR_FRR = *sys.new_Coordinate("xR_FRR","dxR_FRR","ddxR_FRR", 0.0 ,0.0,0.0);

    symbol_numeric aR_FRR = *sys.new_Parameter("aR_FRR",0.066403345669996e+3);//spline's coefficients right wheel
    symbol_numeric bR_FRR = *sys.new_Parameter("bR_FRR",-0.001998816728350e+3);
    symbol_numeric cR_FRR = *sys.new_Parameter("cR_FRR",0.000000000000000e+3);
    symbol_numeric dR_FRR = *sys.new_Parameter("dR_FRR",0.000159000000000e+3);
    symbol_numeric lR_FRR = *sys.new_Parameter("lR_FRR",0.005); //size of the spline 
    ...
    Vector3D rR_FRR = sys.Position_Vector("O","O_RailL")+fR_FRR;
    ...
    Phi(30,0) = u_t1R_FRR * (rW_FRR-rR_FRR);
    Phi(31,0) = u_t2R_FRR * (rW_FRR-rR_FRR);
    Phi(32,0) = u_nR_FRR  * (rW_FRR-rR_FRR);
    ...
    Wrench3D * FKalker_FRR = sys.new_Wrench3D ( "FKalker_FRR", FKALKER_FRR, MKALKER_FRR , Pcon_FRR, FWHSR , "Constitutive") ;
...
cout << " FRL" <<endl; 
    ...
    Vector3D OFWHSR_OWFRL   = *sys.new_Vector3D("OFWHSR_OWFRL", 0,L_WHS/2.0,0,"B_FWHSR"); 
    Point * O_WFRL  = sys.new_Point("O_WFRL","O_FWHSR",&OFWHSR_OWFRL);

    symbol_numeric thetaW_FRL = *sys.new_Coordinate("thetaW_FRL","dthetaW_FRL","ddthetaW_FRL",0.0,0.0,0.0);
    symbol_numeric uW_FRL = *sys.new_Coordinate("uW_FRL","duW_FRL","dduW_FRL",0.0,0.0,0.0);

    symbol_numeric aW_FRL = *sys.new_Parameter("aW_FRL",-0.005980940917141e+4);//spline's coefficients
    symbol_numeric bW_FRL = *sys.new_Parameter("bW_FRL",-0.000002379249587e+4);
    symbol_numeric cW_FRL = *sys.new_Parameter("cW_FRL",-0.000000893613412e+4);
    symbol_numeric dW_FRL = *sys.new_Parameter("dW_FRL",-0.000050000000000e+4);
    symbol_numeric lW_FRL = *sys.new_Parameter("lW_FRL",0.01);//size of the spline
 
    ex sW_FRL = uW_FRL - lW_FRL;
    ex splineW_FRL =   dW_FRL + sW_FRL * ( cW_FRL + sW_FRL * (bW_FRL + sW_FRL * aW_FRL ) );
    Vector3D fW_FRL = *sys.new_Vector3D("fW_FRL",-splineW_FRL*sin(thetaW_FRL),uW_FRL,splineW_FRL*cos(thetaW_FRL),"B_FWHSR");
    ...
    symbol_numeric uR_FRL = *sys.new_Coordinate("uR_FRL","duR_FRL","dduR_FRL", 0.0 ,0.0,0.0);
    symbol_numeric xR_FRL = *sys.new_Coordinate("xR_FRL","dxR_FRL","ddxR_FRL", 0.0 ,0.0,0.0);

    symbol_numeric aR_FRL = *sys.new_Parameter("aR_FRL",0.066403345669996e+3);//spline's coefficients 
    symbol_numeric bR_FRL = *sys.new_Parameter("bR_FRL",-0.001998816728350e+3);
    symbol_numeric cR_FRL = *sys.new_Parameter("cR_FRL",0.000000000000000e+3);
    symbol_numeric dR_FRL = *sys.new_Parameter("dR_FRL",0.000159000000000e+3);
    symbol_numeric lR_FRL = *sys.new_Parameter("lR_FRL",0.005); //size of the spline 
    ...
    Phi(35,0) = u_t1R_FRL * (rW_FRL-rR_FRL);
    Phi(36,0) = u_t2R_FRL * (rW_FRL-rR_FRL);
    Phi(37,0) = u_nR_FRL  * (rW_FRL-rR_FRL);
    Phi(38,0) = u_nR_FRL * t1W_FRL;
    Phi(39,0) = u_nR_FRL * t2W_FRL;

    Point * Pcon_FRL   = sys.new_Point("Pcon_FRL","O",&rR_FRL);

    Vector3D FKALKER_FRL = (Fx_FRL * u_t1R_FRL) + (Fy_FRL * u_t2R_FRL);
    Vector3D MKALKER_FRL = Mz_FRL * u_nR_FRL;

    Wrench3D * FKalker_FRL = sys.new_Wrench3D ( "FKalker_FRL", FKALKER_FRL, MKALKER_FRL , Pcon_FRL, FWHSR , "Constitutive") ;
...
// ************************************************************************************************
    ...
    //REAR BOGIE, FRONT SIDE, RIGHT WHEEL RFR
    ex cryW_RFR = abs(sqrt(fW_RFR(0,0)*fW_RFR(0,0) + fW_RFR(2,0)*fW_RFR(2,0)));  
    ...
    Output(0,0) = sqrt(lambda1*lambda1+lambda2*lambda2+lambda3*lambda3);
    Output(1,0) = (*dxWAG - *dbRWHSF * cryW_RFR);
    Output(2,0) = (*dyWAG - *daRWHSF * cryW_RFR);
    Output(3,0) = (sys.Angular_Velocity("xyz","B_RWHSF") * u_nR_RFR);
    Output(4,0) = *dbRWHSF;
    Output(5,0) = *dxWAG;
    Output(6,0) = cryW_RFR;
    Output(7,0) = crxW_RFR;
    ...
    //REAR BOGIE, FRONT SIDE, LEFT WHEEL RFL
    ex cryW_RFL = abs(sqrt(fW_RFL(0,0)*fW_RFL(0,0) + fW_RFL(2,0)*fW_RFL(2,0)));  
    ...
    Output(10,0) = sqrt(lambda6*lambda6+lambda7*lambda7+lambda8*lambda8);
    Output(11,0) = (*dxWAG - *dbRWHSF * cryW_RFL);    
    Output(12,0) = (*dyWAG - *daRWHSF * cryW_RFL);
    Output(13,0) = (sys.Angular_Velocity("xyz","B_RWHSF") * u_nR_RFL);
    Output(14,0) = *dbRWHSF;
    Output(15,0) = *dxWAG;   
    ...
    //REAR BOGIE, REAR SIDE, RIGHT WHEEL RRR
    ex cryW_RRR = abs(sqrt(fW_RRR(0,0)*fW_RRR(0,0) + fW_RRR(2,0)*fW_RRR(2,0)));  
    ...
    Output(20,0) = sqrt(lambda11*lambda11+lambda12*lambda12+lambda13*lambda13);
    Output(21,0) = (*dxWAG - *dbRWHSR * cryW_RRR);
    Output(22,0) = (*dyWAG - *daRWHSR * cryW_RRR);
    Output(23,0) = (sys.Angular_Velocity("xyz","B_RWHSR") * u_nR_RRR);
    Output(24,0) = *dbRWHSR;
    Output(25,0) = *dxWAG; 
    ...
    ex cryW_RRL = abs(sqrt(fW_RRL(0,0)*fW_RRL(0,0) + fW_RRL(2,0)*fW_RRL(2,0)));  
    ...
    Output(30,0) = sqrt(lambda16*lambda16+lambda17*lambda17+lambda18*lambda18);
    Output(31,0) = (*dxWAG - *dbRWHSR * cryW_RRL);
    Output(32,0) = (*dyWAG - *daRWHSR * cryW_RRL);
    Output(33,0) = (sys.Angular_Velocity("xyz","B_RWHSR") * u_nR_RRL);
    Output(34,0) = *dbRWHSR;
    Output(35,0) = *dxWAG; 
    ...
    //FRONT BOGIE, FRONT SIDE, RIGHT WHEEL FFR
    ex cryW_FFR = abs(sqrt(fW_FFR(0,0)*fW_FFR(0,0) + fW_FFR(2,0)*fW_FFR(2,0)));  
    ...
    Output(40,0) = sqrt(lambda21*lambda21+lambda22*lambda22+lambda23*lambda23);
    Output(41,0) = (*dxWAG - *dbFWHSF * cryW_FFR);
    Output(42,0) = (*dyWAG - *daFWHSF * cryW_FFR);
    Output(43,0) = (sys.Angular_Velocity("xyz","B_FWHSF") * u_nR_FFR);
    Output(44,0) = *dbFWHSF;
    Output(45,0) = *dxWAG;
    ...
    //FRONT BOGIE, FRONT SIDE, LEFT WHEEL FFL
    ex cryW_FFL = abs(sqrt(fW_FFL(0,0)*fW_FFL(0,0) + fW_FFL(2,0)*fW_FFL(2,0)));  
    ...
    Output(50,0) = sqrt(lambda26*lambda26+lambda27*lambda27+lambda28*lambda28);
    Output(51,0) = (*dxWAG - *dbFWHSF * cryW_FFL);    
    Output(52,0) = (*dyWAG - *daFWHSF * cryW_FFL);
    Output(53,0) = (sys.Angular_Velocity("xyz","B_FWHSF") * u_nR_FFL);
    Output(54,0) = *dbFWHSF;
    Output(55,0) = *dxWAG;   
    ...
    //FRONT BOGIE, REAR SIDE, RIGHT WHEEL FRR
    ex cryW_FRR = abs(sqrt(fW_FRR(0,0)*fW_FRR(0,0) + fW_FRR(2,0)*fW_FRR(2,0)));  
    ...
    Output(60,0) = sqrt(lambda31*lambda31+lambda32*lambda32+lambda33*lambda33);
    Output(61,0) = (*dxWAG - *dbFWHSR * cryW_FRR);
    Output(62,0) = (*dyWAG - *daFWHSR * cryW_FRR);
    Output(63,0) = (sys.Angular_Velocity("xyz","B_FWHSR") * u_nR_FRR);
    Output(64,0) = *dbFWHSR;
    Output(65,0) = *dxWAG; 
    ...
    ex cryW_FRL = abs(sqrt(fW_FRL(0,0)*fW_FRL(0,0) + fW_FRL(2,0)*fW_FRL(2,0)));  
    ...
    Output(70,0) = sqrt(lambda36*lambda36+lambda37*lambda37+lambda38*lambda38);
    Output(71,0) = (*dxWAG - *dbFWHSR * cryW_FRL);
    Output(72,0) = (*dyWAG - *daFWHSR * cryW_FRL);
    Output(73,0) = (sys.Angular_Velocity("xyz","B_FWHSR") * u_nR_FRL);
    Output(74,0) = *dbFWHSR;
    Output(75,0) = *dxWAG; 
