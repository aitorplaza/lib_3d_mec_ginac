...
MODELNAME='trainCOMPLETE_discrete_friction_motors';
...
disp('------------------------------------------------------------------------------------')
disp('11: Z EULER with LU Full Pivoting and Dynamic Coordinate Partitioning')
disp('12: Z TRAPEZOIDAL with LU Full Pivoting and Dynamic Coordinate Partitioning')
disp('------------------------------------------------------------------------------------')
disp(' ')
disp('------------------------------------------------------------------------------------')
if (extchoice == 0)
...
if (extchoice == 0)
set_param(MODELNAME, 'SimUserIncludeDirs', '../GENERATED_files_process_c_h ../common/files_c_h/common_c ../common/files_c_h/simulink ../common/files_c_h/lin_alg ../common/files_c_h/osg ../common/files_c_h/lapack ../GENERATED_files_osg/cpp ../GENERATED_files_osg/h')
end
...
if (choice == 1)
 ...
 if (extchoice == 0)
  ...
  fclose(fid);
  set_param(MODELNAME, 'SimUserSources', 'c_s_func_linalg_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c  Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Qgamma.c MXdPhi_dqZero.c one_step_euler_q.c')
 end
end
...
if (choice == 11)
  disp('Z EULER with LU Full Pivoting and Dynamic Coordinate Partitioning')
 if (isunix)
  mex -v -DCOORD_IND -DEULER -DTRI -DFULLPIV c_s_func_linalg_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c one_step_euler_z.c -lm
 end
 if (ispc)
  mex -v -DCOORD_IND -DEULER -DTRI -DFULLPIV c_s_func_linalg_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c one_step_euler_z.c.c
 end
 if (extchoice == 0)
  fid = fopen('../GENERATED_files_process_c_h/external_def.h','w');
  ...
  fprintf(fid,'#define EULER\n');
  fprintf(fid,'#define TRI\n');
  fprintf(fid,'#define FULLPIV\n');
  fclose(fid);
  set_param(MODELNAME, 'SimUserSources', 'c_s_func_linalg_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c Q.c M.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c  one_step_euler_z.c')
 end
end
...
if (choice == 12)
  disp('Z TRAPEZOIDAL with LU Full Pivoting and Dynamic Coordinate Partitioning')
 if (isunix)
  mex -v -DCOORD_IND -DTRAPEZOIDAL -DTRI -DFULLPIV c_s_func_linalg_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c one_step_trapezoidal_z.c -lm
 end  
 if (ispc)
  mex -v -DCOORD_IND -DTRAPEZOIDAL -DTRI -DFULLPIV c_s_func_linalg_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c one_step_trapezoidal_z.c.c
 end
 if (extchoice == 0)
  fid = fopen('../GENERATED_files_process_c_h/external_def.h','w');
  fprintf(fid,'#define COORD_IND\n');
  ...
  fprintf(fid,'#define FULLPIV\n');
  fclose(fid);
  set_param(MODELNAME, 'SimUserSources', 'c_s_func_linalg_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c Q.c M.c  PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c one_step_trapezoidal_z.c')
 end
 end
...
if ((choice~=9)&&(choice~=10)&&(choice~=15)&&(choice~=16))
    ...
    if (isunix)
    mex -v osg_c_s_func.cpp gen_coord.c param.c solids_homogeneous_matrix.cpp osg_root.cpp osg_read_file.cpp osg_state.cpp -lOpenThreads -losg -losgDB -losgUtil -losgViewer -losgGA
    end

    if (ispc)
    INCLUDESPATH = strcat('-I', OSGWINPATH, '\include')
    LIBSPATH = strcat('-L', OSGWINPATH, '\lib')
    mex  -v osg_c_s_func.cpp gen_coord.c param.c solids_homogeneous_matrix.cpp osg_root.cpp osg_read_file.cpp osg_state.cpp '-IC:\Archivos de programa\OpenSceneGraph-3.0.1-VS10.0.30319-x86-release-12741\include' '-LC:\Archivos de programa\OpenSceneGraph-3.0.1-VS10.0.30319-x86-release-12741\lib' -losg -losgDB -losgViewer -losgUtil -losgGA -lOpenThreads
    end
