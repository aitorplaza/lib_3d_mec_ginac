...
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 0 , 35 ,
SS_CALL_MDL_OUTPUTS ) ; ssCallAccelRunBlock ( S , 0 , 36 ,
SS_CALL_MDL_OUTPUTS ) ; } if ( ssIsContinuousTask ( S , tid ) ) { ( (
BlockIO_trainCOMPLETE_discrete_firction_motors * ) _ssGetBlockIO ( S ) ) ->
B_0_37_0 = ssGetT ( S ) ; } if ( ssIsSampleHit ( S , 1 , tid ) ) {
...
ssSetChecksumVal ( S , 0 , 3756410117U ) ; ssSetChecksumVal ( S , 1 ,
3698085277U ) ; ssSetChecksumVal ( S , 2 , 2182833088U ) ; ssSetChecksumVal (
S , 3 , 1526390717U ) ; { mxArray * slVerStructMat = NULL ; mxArray *
