...
MODEL              = trainCOMPLETE_discrete_firction_motors
MODULES            = mu_div_mod_vel_sliding_vel_wrapper.c rtGetInf.c rtGetNaN.c rt_nonfinite.c trainCOMPLETE_discrete_firction_motors_acc_data.c 
MAKEFILE           = trainCOMPLETE_discrete_firction_motors.mk
MATLAB_ROOT        = /usr/local/MATLAB/R2011b
ALT_MATLAB_ROOT    = /usr/local/MATLAB/R2011b
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/aitor/3d_mec/lib_3d_mec_ginac/examples/train_complete/SOURCE_matlab
S_FUNCTIONS        = mu_div_mod_vel_sliding_vel_wrapper.c c_s_func_linalg_discrete.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 3
TID01EQ            = 1
...
MODELLIB                  = trainCOMPLETE_discrete_firction_motorslib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/trainCOMPLETE_discrete_firction_motors \
	-I$(START_DIR) \
