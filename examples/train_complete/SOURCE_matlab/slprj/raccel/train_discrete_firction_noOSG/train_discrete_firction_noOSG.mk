...
#
# File    : raccel_unix.tmf   $Revision: 1.1.6.22 $
#
# Abstract:
...
MODEL                  = train_discrete_firction_noOSG
MODULES                = rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c train_discrete_firction_noOSG_data.c 
MAKEFILE               = train_discrete_firction_noOSG.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2011b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2011b
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2011b\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/aitor/3d_mec/lib_3d_mec_ginac/examples/train_wheelset/SOURCE_matlab
S_FUNCTIONS            = c_s_func_linalg_discrete.c mu_div_mod_vel_sliding_vel_wrapper.c
S_FUNCTIONS_LIB        = 
COMPUTER               = GLNX86
BUILDARGS              =  GENERATE_REPORT=0 RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/usr/local/MATLAB/R2011b" EXT_MODE=1
...
MODELLIB                  = train_discrete_firction_noOSGlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/raccel/train_discrete_firction_noOSG \
	-I$(START_DIR) \
...
ifeq ($(RACCEL_PARALLEL_FOREACH_SS), 1)
   CPP_REQ_DEFINES += -DRACCEL_PARALLEL_FOREACH	\
...
SRCS = $(REQ_SRCS) $(S_FUNCTIONS) $(PARFOR_SRCS)
