...
// ************************************************************************************************
	...
	sys.new_Base("B03","xyz",0,0,1,4.0*alfa);
...
// ************************************************************************************************
    ...
    Vector3D eq1 = sys.Position_Vector(A1,D1);
    Vector3D eq2 = sys.Position_Vector(A2,D2);
    Vector3D eq3 = sys.Position_Vector(A3,D3);
    Vector3D eq4 = sys.Position_Vector(A4,D4);   
    Vector3D eq5 = sys.Position_Vector(A5,D5);
    Vector3D eq6 = sys.Position_Vector(A6,D6);   
	...
	Phi(16,0)=eq6(1,0);
	Phi(17,0)=eq6(2,0);
cout <<unatomize_ex(eq1(0,0))<<endl;
/*
double	kons=1.0;
...
// ************************************************************************************************
    ...
    lst new_atom_list_DE, new_exp_list_DE;        
	matrix_list_optimize (Dynamic_Equations, new_atom_list_DE, new_exp_list_DE);
    sys.export_function_MATLAB("DE", "DE_", Dynamic_Equations, new_atom_list_DE, new_exp_list_DE,"q,dq,ddq,time,param");
...
//~ // 	sys.export_function_MATLAB_SYMPY("W_optim","W_optim_",W);
	...
	sys.export_function_MATLAB("W", "W_", W, new_atom_list_W, new_exp_list_W,"q,dq,ddq,time,param");
//~ 
...
Matrix WPhio= W*M_inertial_parameters;
...
cout << "W  cols, rows = "<< W.cols() << "," << W.rows()<<endl;
cout << "WPhinew  cols, rows = "<< WPhinew.cols()<< "," << WPhinew.rows()<<endl;
...
//~ cout <<"W atom = " << new_atom_list_Wnew.nops()<<endl;
//~ ex = system("python op_counter.py Wnew.m");
...
//~ cout <<"W atom = " << new_atom_list_Wnew.nops()<<endl;
//~ e = system("python op_counter.py Wnew.m");
cout <<"WPhi atom = " << new_atom_list_WPhinew.nops()<<endl;
ex = system("python op_counter.py WPhinew.m");
