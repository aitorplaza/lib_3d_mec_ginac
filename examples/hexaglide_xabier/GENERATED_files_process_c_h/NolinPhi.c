...
_NolinPhi[0] =  cos(a1)*atom81*atom48-atom81*sin(a1)*atom46+atom42*sin(b1);
_NolinPhi[1] = -atom105*sin(a2)*atom46+atom105*cos(a2)*atom48+atom42*sin(b2);
_NolinPhi[2] =  cos(a3)*atom129*atom48-( atom129*atom3*atom132-atom130*atom1)*atom46+atom42*( atom3*atom130+atom129*atom132*atom1);
_NolinPhi[3] = -( atom3*atom169*atom172-atom170*atom1)*atom46+atom42*( atom169*atom172*atom1+atom170*atom3)+cos(a4)*atom48*atom169;
_NolinPhi[4] =  atom209*cos(a5)*atom48-( atom209*atom214*atom212-atom210*atom215)*atom46+atom42*( atom210*atom214+atom209*atom212*atom215);
_NolinPhi[5] =  cos(a6)*atom252*atom48+( atom214*atom253+atom255*atom215*atom252)*atom42-( atom214*atom255*atom252-atom215*atom253)*atom46;
