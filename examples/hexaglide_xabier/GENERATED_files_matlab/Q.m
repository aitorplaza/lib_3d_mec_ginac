...
Q_ = [-(atom4226*atom4138-atom4223*atom4139)*mxP-(atom4135*atom4223-atom4220*atom4138)*mzP-(atom77*atom1493+atom72*atom1490)*da+myP*(atom4135*atom4226-atom4220*atom4139)+dB*(atom77*atom4193-atom72*atom4194);
atom67*atom1490*da+myP*(atom4235*atom4135-atom4139*atom4229)-mzP*(atom4135*atom4232-atom4229*atom4138)-(atom4235*atom4138-atom4232*atom4139)*mxP+dB*(atom67*atom4194-atom77*atom293);
g*mP-dB*(atom67*atom4193-atom72*atom293)-(atom4238*atom4139-atom4135*atom4244)*myP+(atom4241*atom4139-atom4244*atom4138)*mxP+atom67*da*atom1493+(atom4238*atom4138-atom4135*atom4241)*mzP;
atom42*atom4350-atom49*atom5259-atom42*atom1497+atom49*atom4348+atom50*atom4349-atom5262*atom50;
-atom5259*atom40-atom5262*atom39+atom39*atom4349+atom4348*atom40;
-atom1497+atom4350;
-atom82*(atom82*atom102+atom86*atom103)+((Ixy1*atom3157-Ixx1*dB1)*atom3157+atom3204*Izz1+atom3163*(atom4464+atom4453)-(Ixy1*dB1-Iyy1*atom3157)*dB1+Ixz1*atom3164)*atom82-atom81*(atom81*atom102+atom103*atom85)+atom81*((atom4453+atom4452)*atom3157+Ixx1*atom3164-atom3163*(atom3163*Iyz1+Izz1*dB1)+(atom3163*Iyy1+dB1*Iyz1)*dB1+Ixz1*atom3204);
atom106*(Ixz2*atom3244+Izz2*atom3284-(Ixx2*dB2-Ixy2*atom3239)*atom3239-(Ixy2*dB2-atom3239*Iyy2)*dB2+(atom4602+atom4591)*atom3243)+atom105*(Ixz2*atom3284-atom3243*(atom3243*Iyz2+Izz2*dB2)+(atom3243*Iyy2+dB2*Iyz2)*dB2+Ixx2*atom3244+(atom4590+atom4591)*atom3239)-atom106*(atom106*atom126+atom110*atom127)-atom105*(atom105*atom126+atom127*atom109);
atom129*(atom2642*Ixz3+atom2587*Ixx3-atom2586*(Iyz3*atom2586+dB3*Izz3)+(atom4741+atom4742)*atom2592+(Iyy3*atom2586+Iyz3*dB3)*dB3)+atom130*(dB3*(Iyy3*atom2592-dB3*Ixy3)+atom2586*(atom4753+atom4742)+atom2587*Ixz3+atom2642*Izz3-(Ixx3*dB3-Ixy3*atom2592)*atom2592)-atom129*(atom139*atom166+atom167*atom145)-(atom148*atom167+atom142*atom166)*atom130;
(Ixx4*atom2741-(dB4*Izz4+Iyz4*atom2740)*atom2740+Ixz4*atom2796+(atom4892+atom4893)*atom2747+dB4*(Iyz4*dB4+Iyy4*atom2740))*atom169-(atom179*atom206+atom207*atom185)*atom169-atom170*(atom182*atom206+atom188*atom207)+atom170*(Izz4*atom2796+(atom2747*Ixy4-Ixx4*dB4)*atom2747+Ixz4*atom2741-dB4*(dB4*Ixy4-Iyy4*atom2747)+(atom4904+atom4893)*atom2740);
-atom210*(atom250*atom231+atom249*atom225)+atom210*(Ixz5*atom2902+(atom5055+atom5044)*atom2901+atom2955*Izz5+dB5*(Iyy5*atom2890-dB5*Ixy5)-atom2890*(dB5*Ixx5-atom2890*Ixy5))-atom209*(atom250*atom228+atom222*atom249)+atom209*((Iyy5*atom2901+Iyz5*dB5)*dB5-(dB5*Izz5+Iyz5*atom2901)*atom2901+atom2890*(atom5043+atom5044)+Ixz5*atom2955+Ixx5*atom2902);
-(atom262*atom289+atom268*atom290)*atom252+(Ixz6*atom3054+(Ixy6*atom3045-dB6*Ixx6)*atom3045+atom3108*Izz6+atom3053*(atom5206+atom5195)-dB6*(Ixy6*dB6-Iyy6*atom3045))*atom253+((atom5195+atom5194)*atom3045+dB6*(Iyz6*dB6+Iyy6*atom3053)+atom3054*Ixx6-(dB6*Izz6+Iyz6*atom3053)*atom3053+atom3108*Ixz6)*atom252-(atom271*atom290+atom265*atom289)*atom253;
-(atom3163*Ixx1+Ixz1*atom3157)*atom3157+atom3163*(Izz1*atom3157+atom3163*Ixz1)+dB1*(atom4464-atom4452)+Ixy1*atom3164+atom3204*Iyz1-atom83*atom103;
-(Ixz2*atom3239+atom3243*Ixx2)*atom3239-dB2*(atom4590-atom4602)+Iyz2*atom3284-atom107*atom127+Ixy2*atom3244+atom3243*(atom3243*Ixz2+Izz2*atom3239);
atom2586*(Izz3*atom2592+Ixz3*atom2586)-atom133*atom166-atom135*atom167+Iyz3*atom2642+atom2587*Ixy3-(Ixz3*atom2592+atom2586*Ixx3)*atom2592-dB3*(atom4741-atom4753);
-(Ixx4*atom2740+Ixz4*atom2747)*atom2747+Iyz4*atom2796+(atom2747*Izz4+Ixz4*atom2740)*atom2740-atom175*atom207+atom2741*Ixy4-atom173*atom206-dB4*(atom4892-atom4904);
(Ixz5*atom2901+atom2890*Izz5)*atom2901-(Ixx5*atom2901+Ixz5*atom2890)*atom2890+Iyz5*atom2955+atom2902*Ixy5-atom249*atom216-atom250*atom218-dB5*(atom5043-atom5055);
atom3108*Iyz6+atom3053*(atom3045*Izz6+atom3053*Ixz6)-atom289*atom256-atom258*atom290+Ixy6*atom3054+dB6*(atom5206-atom5194)-(Ixz6*atom3045+atom3053*Ixx6)*atom3045;
(atom4396*dB1-atom4399*atom3157)*mz1-mx1*(atom3163*atom4399+atom4402*dB1)+da1*atom84*dB1*atom91-Fs1+g*m1+(atom3163*atom4396+atom4402*atom3157)*my1;
-Fs2+da2*dB2*atom108*atom115+mz2*(atom4534*dB2-atom4537*atom3239)+g*m2-mx2*(atom3243*atom4537+dB2*atom4540)+(atom4540*atom3239+atom3243*atom4534)*my2;
da3*(atom134*atom160*dB3-atom155*dB3*atom136)-mx3*(atom2586*atom4688+dB3*atom4691)+(atom2592*atom4691+atom4685*atom2586)*my3-mz3*(atom2592*atom4688-atom4685*dB3)+g*m3-Fs3;
(atom4842*atom2747+atom2740*atom4836)*my4+da4*(atom200*dB4*atom174-atom176*dB4*atom195)+g*m4-mx4*(atom4839*atom2740+atom4842*dB4)-mz4*(atom4839*atom2747-dB4*atom4836)-Fs4;
my5*(atom4987*atom2901+atom2890*atom4993)-Fs5+g*m5-(atom4990*atom2890-atom4987*dB5)*mz5-(atom4990*atom2901+dB5*atom4993)*mx5+(atom243*dB5*atom217-atom238*dB5*atom219)*da5;
-(atom5144*dB6+atom3053*atom5141)*mx6+mz6*(dB6*atom5138-atom5141*atom3045)+my6*(atom3053*atom5138+atom5144*atom3045)-Fs6-(dB6*atom259*atom278-dB6*atom257*atom283)*da6+g*m6];
