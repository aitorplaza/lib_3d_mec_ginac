...
echo "18: Z TRAPEZOIDAL LU Full Pivoting decomposition"
echo " "
...
COORD_Z_mod="PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c M.c Q.c"
COORD_Z_mod_o="PhiInit.o PhiInit_q.o dPhiInit_dq.o BetaInit.o Phi_q.o dPhi_dq.o M.o Q.o"

COORD_Z_mod2="PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c M.c Q.c"
COORD_Z_mod2_o="PhiInit.o PhiInit_q.o dPhiInit_dq.o BetaInit.o Phi_q.o dPhi_dq.o M.o Q.o"
...
gcc -DEULER -DCOORD_DEP -DROBUST_SOLVER -DDDL -DINV $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $LA_Q $DYN_DDL one_step_euler_q.c
g++ -c $OSG
gcc  -DEULER -DCOORD_DEP -DROBUST_SOLVER -DDDL -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $LA_Q_o $OSG_o read_config_file.c one_step_euler_q.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
fi
if [ "$OPTION" == 4 ];  then 
...
gcc -DTRAPEZOIDAL -DCOORD_DEP -DDDL -DINV $TOL -O2 -c read_config_file.c $COMMON $COORD_Q $L_A $LA_Q $DYN_DDL one_step_trapezoidal_q.c
g++ -c $OSG
gcc  -DTRAPEZOIDAL -DCOORD_DEP -DDDL -DINV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Q_o $DYN_DDL_o $L_A_o $LA_Q_o $OSG_o read_config_file.c one_step_trapezoidal_q.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
fi
if [ "$OPTION" == 8 ];  then 
...
gcc -DTRAPEZOIDAL -DCOORD_IND -DTRI -DFULLPIV $TOL -O2 -c read_config_file.c $COMMON $COORD_Z $L_A $LA_Z one_step_trapezoidal_z.c
g++ -c $OSG
gcc -DTRAPEZOIDAL -DCOORD_IND -DTRI -DFULLPIV $TOL -DLIN_ALG -O2 -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_o $L_A_o $LA_Z_o $OSG_o read_config_file.c one_step_trapezoidal_z.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
fi
#####################################################################################################################################################

#####################################################################################################################################################
if [ "$OPTION" == 19 ];  then 
echo "Z TRAPEZOIDAL with LU Test Full Pivot";
gcc -DTRAPEZOIDAL -DCOORD_IND -DTRI -DFULLPIV $TOL -g -c read_config_file.c $COMMON $COORD_Z_mod2 $L_A $LA_Z one_step_trapezoidal_z.c
g++ -c $OSG
gcc -DTRAPEZOIDAL -DCOORD_IND -DTRI -DFULLPIV $TOL -DLIN_ALG  -g -o $MAIN $MAIN.cc $COMMON_o $COORD_Z_mod2_o $L_A_o $LA_Z_o $OSG_o read_config_file.c one_step_trapezoidal_z.o -lOpenThreads -losg -losgDB -losgGA -losgUtil -losgViewer -losgText -lm -lblas -llapack
fi
#####################################################################################################################################################
