...
//  symbol_numeric L2y = *sys.new_Parameter("L2y",3.0);
    ...
    symbol_numeric LS2x1 = *sys.new_Parameter("LS2x1",-0.560136);// antes 1.1697
    symbol_numeric LS2y1 = *sys.new_Parameter("LS2y1",0.8777);
    symbol_numeric LS2z1 = *sys.new_Parameter("LS2z1",1.094110);	//antes 1.1308

    // The second group of silent-blocks (the four silent-blocks of the generator)
    #ifdef ALIGNED
        symbol_numeric LS2x2 = *sys.new_Parameter("LS2x2",3.3586463);
        symbol_numeric LS2x3 = *sys.new_Parameter("LS2x3",4.4259796);
    ...
    #ifdef ALIGNED
        symbol_numeric LB2x = *sys.new_Parameter("LB2x",0.603913);//before 2.5
        symbol_numeric LB2y = *sys.new_Parameter("LB2y",0.3);
        symbol_numeric LB2z = *sys.new_Parameter("LB2z",1.97181);
    #else
        symbol_numeric LB2x = *sys.new_Parameter("LB2x",0.603913);//before 2.50
        symbol_numeric LB2y = *sys.new_Parameter("LB2y",0.3);
        symbol_numeric LB2z = *sys.new_Parameter("LB2z",1.97181);
    #endif
    ...
    #ifdef ALIGNED
        symbol_numeric L4x = *sys.new_Parameter("L4x",1.4892);
    ...
    symbol_numeric LS4x = *sys.new_Parameter("LS4x",0.49635);   // L4Sx is common for the two silent-blocks
    ...
    symbol_numeric LS7x1 = *sys.new_Parameter("LS7x1",1.69753);//draw 0.8
    symbol_numeric LS7x2 = *sys.new_Parameter("LS7x2",2.76486);//draw 2.45
    ...
    symbol_numeric LGy1 = *sys.new_Parameter("LGy1",0.52325);   
    symbol_numeric LGz1 = *sys.new_Parameter("LGz1",0.80009);   
...
//Define Drawings
    ...
    Drawing3D  * D_R2 = sys.new_Drawing3D ("R2","O2","B2a","./solids/SolR2.osgt",1.0,0.0,0.0,1.0); 
    ...
    Drawing3D  * D_RSun = sys.new_Drawing3D ("RSun","OSun","BSun","./solids/SolRSun.ive",1.0,0.4,0.4,1.0);
...
// -----------------------------------------------------------------------------------------------    
  ...
  //ex R_Pla = Z_Pla*modulus_1/2;
  //ex R_Sun = Z_Sun*modulus_1/2;
  //ex R_Ring = Z_Ring*modulus_1/2;
  //ex R_SecSt_1 = Z_SecSt1*modulus_1/2;
  //ex R_SecSt_2 = Z_SecSt2*modulus_1/2;
  //ex L_Sun_SecSt = R_SecSt_1+R_SecSt_2;
  //ex R_ThiSt_1 = Z_ThiSt1*modulus_2/2;
  //ex R_ThiSt_2 = Z_ThiSt2*modulus_2/2;
...
/*    Matrix Output(Coordinates.size()+Velocities.size()+Joint_Unknowns.size()+3,1);
   ...
   //Output(5,0) = *da5/(*da3); 
    ...
    //GBBearing7 Gearbox-SecSt2-OSecSt
    ...
    //GBBearing8 Gearbox-SecSt2-ThirSt1
    ...
    //GBBearing9 Gearbox-ThirSt2-HSS
