...
void Init_MQnew ( ) 
{
    _MQnew = malloc ( MQnew_n_rows * MQnew_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < MQnew_n_rows * MQnew_n_cols ; i++ ) {_MQnew[i]=0.0;}
  }
}
...
atom25 = sin(a1);
atom5349 = atom80*Ma5;
atom5355 = atom81*Ma6*atom115;
atom5392 = atom81*atom5388;

_MQnew[36] = -Ma6*( atom58*atom114+atom115*atom94)+atom58*atom5356-Ma1-atom5388*atom94;
_MQnew[37] = -atom5392-atom5355-Ma2;
_MQnew[38] = -Ma3-atom5392-atom5355;
_MQnew[39] = -Ma4;
_MQnew[40] = -Ma5;
_MQnew[41] = -Ma6;
