...
void Init_Qnew ( ) 
{
    _Qnew = malloc ( Qnew_n_rows * Qnew_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < Qnew_n_rows * Qnew_n_cols ; i++ ) {_Qnew[i]=0.0;}
  }
}
...
_Qnew[0] = -Ma6*( atom58*atom114+atom115*atom94)+atom58*atom5356-Ma1-atom5388*atom94;
_Qnew[1] = -atom5392-atom5355-Ma2;
_Qnew[2] = -Ma3-atom5392-atom5355;
_Qnew[3] = -Ma4;
_Qnew[4] = -Ma5;
_Qnew[5] = -Ma6;
