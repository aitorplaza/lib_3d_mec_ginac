/*----------MQrecsubs.c lib3D_MEC exported-----------*/
...
double * _MQrecsubs = NULL;
void Init_MQrecsubs ( ) 
{
    _MQrecsubs = malloc ( MQrecsubs_n_rows * MQrecsubs_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < MQrecsubs_n_rows * MQrecsubs_n_cols ; i++ ) {_MQrecsubs[i]=0.0;}
  }
}
...
_MQrecsubs[0] =  atom35*( atom5687*atom2582-r3*( atom2582*atom5582+atom2579*atom5590)+atom35*Iyy2-atom2579*atom5705+atom36*Ixy2+d3*( m3*atom299+atom5562-atom4602*mx3+atom4606*my3))-( atom5687*atom2579-atom36*Ixx2-r3*atom5717+atom2582*atom5705-atom35*Ixy2)*atom36+Izz1;
_MQrecsubs[1] =  atom5717*d3-atom36*Ixz2+atom7796-atom35*Iyz2;
_MQrecsubs[2] = atom7796;
_MQrecsubs[3] = atom5701;
_MQrecsubs[4] = atom5673;
_MQrecsubs[5] = atom5614;
_MQrecsubs[6] = -atom36*( atom2582*atom5863-r3*atom5875+atom5854*atom2579+Ixz2)-atom35*( atom2579*atom5863+Iyz2+r3*( atom2579*atom5805+atom2582*atom5798)-atom5854*atom2582-d3*atom5785);
_MQrecsubs[7] =  atom5875*d3+atom6204+Izz2;
_MQrecsubs[8] = atom6204;
_MQrecsubs[9] = atom5859;
_MQrecsubs[10] = atom5848;
_MQrecsubs[11] = atom5818;
_MQrecsubs[12] =  atom36*( r3*atom6001-atom5991*atom2582-atom5983*atom2579)+atom35*( atom5922*d3-r3*( atom2582*atom5930+atom5935*atom2579)-atom5991*atom2579+atom5983*atom2582);
_MQrecsubs[13] =  atom6215+d3*atom6001;
_MQrecsubs[14] = atom6215;
_MQrecsubs[15] = atom5988;
_MQrecsubs[16] = atom5977;
_MQrecsubs[17] = atom5947;
_MQrecsubs[18] = -atom36*( atom6063*atom2579-r3*atom6080+atom2582*atom6070)+atom35*( atom6063*atom2582-r3*( atom6044*atom2579-atom2582*atom6040)-atom2579*atom6070+atom6036*d3);
_MQrecsubs[19] =  atom6224+d3*atom6080;
_MQrecsubs[20] = atom6224;
_MQrecsubs[21] = atom6068;
_MQrecsubs[22] = -atom3889;
_MQrecsubs[23] = atom3822;
_MQrecsubs[24] =  atom36*( r3*atom6144-atom2579*atom6128-atom6134*atom2582)-atom35*( r3*( atom6111*atom2579-atom2582*atom6107)-atom2582*atom6128-d3*atom6103+atom6134*atom2579);
_MQrecsubs[25] =  atom6233+atom6144*d3;
_MQrecsubs[26] = atom6233;
_MQrecsubs[27] = atom6132;
_MQrecsubs[28] = -atom3890;
_MQrecsubs[29] = atom3839;
_MQrecsubs[30] = -atom36*( atom2582*atom6181+atom2579*atom6176-r3*atom6191)+( atom2582*atom6176-atom2579*atom6181+atom6155*d3-r3*( atom2579*atom6161-atom6157*atom2582))*atom35;
_MQrecsubs[31] =  atom6242+atom6191*d3;
_MQrecsubs[32] = atom6242;
_MQrecsubs[33] = atom6179;
_MQrecsubs[34] = atom3839;
_MQrecsubs[35] = Izz6;
_MQrecsubs[36] = -( Ixx2*atom2486-atom4465*da2-atom4436*mz2+atom2579*atom5408+atom4467*atom2450+atom2582*atom5432-atom2485*Ixy2-r3*atom5446)*atom36-atom35*( atom4435*mz2+r3*( atom2582*atom5284+atom5296*atom2579)+Ixy2*atom2486+da2*atom4462-( atom5256+atom5126*mx3+atom5120*my3+m3*atom5131-mz3*( atom4519+atom4515))*d3-Iyy2*atom2485-atom2582*atom5408-atom4467*atom2449+atom2579*atom5432);
_MQrecsubs[37] =  atom5467-atom4462*atom2450+atom2486*Ixz2-atom2485*Iyz2+atom4465*atom2449-atom4435*my2+atom4436*mx2+atom5446*d3;
_MQrecsubs[38] = atom5467;
_MQrecsubs[39] = atom5423;
_MQrecsubs[40] = atom5393;
_MQrecsubs[41] = atom5329;
