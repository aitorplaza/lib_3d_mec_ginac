...
atom3318 = 2.0*t;
atom3320 = 2.0*cos(atom3318);
atom3314 = 4.0*t;
atom3327 = 4.0*cos(atom3314);
atom3316 = -4.0*sin(atom3314);
atom3337 = cos(t);
atom3322 = 3.0*t;
atom3332 = 3.0*cos(atom3322);
atom3329 = sin(t);
atom3324 = -3.0*sin(atom3322);
atom3335 = -2.0*sin(atom3318);

_BetaInit[0] =  FSb21*atom3335+atom3324*FSb31+FSa31*atom3332+FSa11*atom3337-atom3329*FSb11+FSb41*atom3316+FSa41*atom3327+FSa21*atom3320;
_BetaInit[1] =  atom3337*FSa12+FSb32*atom3324-atom3329*FSb12+FSb42*atom3316+FSa22*atom3320+atom3335*FSb22+FSa32*atom3332+atom3327*FSa42;
_BetaInit[2] =  FSb33*atom3324+atom3335*FSb23+FSa13*atom3337+atom3332*FSa33+FSa43*atom3327+FSa23*atom3320+atom3316*FSb43-FSb13*atom3329;
_BetaInit[3] =  FSa34*atom3332+FSa14*atom3337+FSb44*atom3316+FSa24*atom3320-atom3329*FSb14+FSa44*atom3327+FSb34*atom3324+atom3335*FSb24;
_BetaInit[4] =  FSa35*atom3332+FSb45*atom3316+FSb35*atom3324+FSa45*atom3327+FSa15*atom3337+FSb25*atom3335-atom3329*FSb15+atom3320*FSa25;
_BetaInit[5] =  FSb46*atom3316+FSa36*atom3332+FSa46*atom3327+atom3324*FSb36+FSb26*atom3335+FSa16*atom3337-atom3329*FSb16+atom3320*FSa26;
