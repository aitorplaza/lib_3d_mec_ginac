...
double * _WPhinew = NULL;
void Init_WPhinew ( ) 
{
    _WPhinew = malloc ( WPhinew_n_rows * WPhinew_n_cols * sizeof(double) );
  {int i;
  for ( i = 0 ; i < WPhinew_n_rows * WPhinew_n_cols ; i++ ) {_WPhinew[i]=0.0;}
  }
}
