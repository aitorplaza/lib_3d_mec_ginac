...
# ~ sio.savemat('puma_ele.mat', mdict={'puma_ele':np.transpose(vect)})
# ~ sio.savemat('puma_add.mat', mdict={'puma_add':np.transpose(vect)})
# ~ sio.savemat('puma_qr.mat', mdict={'puma_qr':np.transpose(vect)})
sio.savemat('puma_L1.mat', mdict={'puma_L1':np.transpose(vect)})
