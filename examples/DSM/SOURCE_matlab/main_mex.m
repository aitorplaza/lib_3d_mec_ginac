...
if (choice == 4)
  ...
  if (isunix)
   mex -v -DLIN_ALG -DCOORD_DEP -DTRAPEZOIDAL -DDDL -DTRI_LDL c_s_func_discrete.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Qgamma.c MXdPhi_dqZero.c one_step_trapezoidal_q.c -lm
  end
   if (ispc)
...
if (choice == 10)
 ...
 if (isunix)
  mex -v -DLIN_ALG -DCOORD_DEP -DDDL -DTRI_LDL c_s_func_continuous.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Qgamma.c MXdPhi_dqZero.c -lm
 end  
 if (ispc)
  mex -v -DLIN_ALG -DCOORD_DEP -DDDL -DTRI_LDL c_s_func_continuous.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Qgamma.c MXdPhi_dqZero.c 
 end
...
if (choice == 11)
 ...
 if (isunix)
  mex -v -DLIN_ALG -DCOORD_DEP -DDDQ -DTRI_LDL c_s_func_continuous.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c -lm
 end  
 if (ispc)
  mex -v -DLIN_ALG -DCOORD_DEP -DDDQ -DTRI_LDL c_s_func_continuous.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c 
 end
end
if (choice == 12)
 disp('Independent Velocity Formalism and MATLAB integrator, solving with LIN_ALG library')
 if (isunix)
  mex -v -DLIN_ALG -DCOORD_IND  c_s_func_continuous.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c -lm
 end  
 if (ispc)
  mex -v -DLIN_ALG -DCOORD_IND  c_s_func_continuous.c lin_alg.c time.c gen_coord.c gen_vel.c gen_accel.c param.c unknowns.c inputs.c Output.c Initial_position_velocity.c Phi.c Beta.c Gamma.c write_data_file.c PhiInit.c PhiInit_q.c dPhiInit_dq.c BetaInit.c Phi_q.c dPhi_dq.c Q.c M.c
 end
end
