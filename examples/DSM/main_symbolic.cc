...
// ************************************************************************************************
    ...
    //sys.new_Base("B_DISC" ,"B_ARM2",1,0,0, -psi);   //Base disc
...
// ************************************************************************************************
    ...
    Vector3D OArm1_GArm1= *sys.new_Vector3D("OArm1_GArm1",0,l1/2.0,0,"B_ARM1");
    ...
    Vector3D OArm2_GArm2= *sys.new_Vector3D("OArm2_GArm2",0,l2/2.0,0,"B_ARM2");
    ...
    ex IDisc1=atomize_ex((1.0/2.0)*(r*r)*mDisc);
    ex IDisc2=atomize_ex((1.0/4.0)*(r*r)*mDisc);
    ex IDisc3=atomize_ex((1.0/4.0)*(r*r)*mDisc);
    ...
    ex IEllipse1=atomize_ex((1.0/4.0)*(a*a+b*b)*mEllipse);
    ex IEllipse2=atomize_ex((1.0/4.0)*(a*a)*mEllipse);
    ex IEllipse3=atomize_ex((1.0/4.0)*(b*b)*mEllipse);
...
// ************************************************************************************************
	...
	#ifdef DISC
	ex curve_eq= atomize_ex((G_P * G_P)-(r*r));         
	#elif defined ELLIPSE
	ex Elipse1 = atomize_ex(1);
	ex Elipse2 = atomize_ex(1/(a*a));
	ex Elipse3 = atomize_ex(1/(b*b));
	Tensor3D MElipse = *sys.new_Tensor3D("MElipse",(ex)Elipse1,(ex)0,(ex)0,(ex)0,(ex)Elipse2,(ex)0,(ex)0,(ex)0,(ex)Elipse3,"B_DISC");
	ex curve_eq = atomize_ex( (G_P * (MElipse * G_P))-1 ); 
	#endif
...
// ************************************************************************************************
    //~ cout <<"atomos totales= " << atoms.size()<<endl;
//~ 
    //~ ex a_exp; 
    //~ int counter = 0;
    //~ for (int i = 0; i < atoms.size();i++){
        ...
        //~ //cout <<a<< " = "<< a_exp<< " -> "<< recursive_ops_counter(a_exp) << endl;
        //~ counter = counter + recursive_ops_counter(a_exp);
    //~ }
    //~ cout <<"operaciones totales= " << counter <<endl;
    //~ 
//~ printf ("GENERACION =======================================================>  %f seconds\n",(double) (t1 - t0)/CLOCKS_PER_SEC);
//~ printf ("EQUATIONS  =======================================================>  %f seconds\n",(double) (t2 - t1)/CLOCKS_PER_SEC);     
//~ printf ("CALCULO MATRICES =================================================>  %f seconds\n",(double) (t4 - t3)/CLOCKS_PER_SEC);    
//~ printf ("EXPORTAR         =================================================>  %f seconds\n",(double) (t5 - t4)/CLOCKS_PER_SEC); 
//~ printf ("TOTAL            =================================================>  %f seconds\n",(double) (t5 - t0)/CLOCKS_PER_SEC); 
